...
?>        
                    ...
                    <div class="content content-full">
                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                            ...
                            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                                ...
                                <div class="row">
                                <div >
                                <a href="{{ url('person_guesthouse/guesthouse_dashboard/'.$id_user)}}" class="btn btn-info loadscreen" >Dashboard</a>
                                </div>
                                <div>&nbsp;</div>
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>รายละเอียดการเข้าพักอาศัย</B></h3>
          
        </div>
        <div class="block-content block-content-full">

          - รายละเอียดบานพักหรือห้อง
          - รายละเอียดสมาขิก
          - ประวัติการซ่อม
          - ค่าน้ำค่าไฟเจ้าตัว
          - ค่าน้ำค่าไฟ บ้านพัก
