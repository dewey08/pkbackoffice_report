    ...
    <div class="content">
        <div class="block block-rounded block-bordered">
            <div class="block-content">    
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขใบสลิปเงินเดือน</h2> 
                <form  method="post" action="{{ route('compensation.salaryslip_update') }}" enctype="multipart/form-data"> 
                @csrf

                <input type="hidden" name="SLIP_ID" id="SLIP_ID" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{ $inforSalaryslip-> SLIP_ID }}">
                ...
                <div class="col-sm-2">
                    ...
                    <div class="col-lg-2">        
                        <input name="SLIP_NUMBER" id="SLIP_NUMBER" class="form-control input-sm" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;"value="{{ $inforSalaryslip-> SLIP_NUMBER }}" >
                    </div>
                    <div class="col-sm-2 text-right">
                        <label>ลงวันที่ต้องการ :</label>
                    </div> 
                    <div class="col-lg-2">        
                        <input name="SLIP_DATE" id="SLIP_DATE" class="form-control input-sm datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" value="{{formate($inforSalaryslip-> SLIP_DATE) }}" readonly>
                    </div>
                    <div class="col-sm-2 text-right">
                        <label>ปีงบประมาณ :</label>
                    </div>         
                    <div class="col-lg-2">        
                    <select name="SLIP_YEAR" id="SLIP_YEAR" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{ $inforSalaryslip-> SLIP_YEAR }}">
                ...
                <div class="row push">
                    ...
                    <div class="col-sm-2">
                        <input name="SLIP_MOUNT" id="SLIP_MOUNT" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{ $inforSalaryslip-> SLIP_MOUNT }}" OnKeyPress="return chkNumber(this)"> 
                    </div>
                    <div class="col-sm-1">
                ...
                <div class="row push">
                    ...
                    <div class="col-sm-10">
                        <input name="SLIP_COMMENT" id="SLIP_COMMENT" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"value="{{$inforSalaryslip->SLIP_COMMENT}}" >
                    </div>
                </div>
