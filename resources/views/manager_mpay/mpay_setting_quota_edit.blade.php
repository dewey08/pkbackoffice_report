    ...
    <div class="block-content">
        ...
        @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="DEP_QUOTA_QUANTITY">จำนวนโควตา</label> <span class="text-danger">*</span>
                        <input type="number" class="js-maxlength form-control f-kanit js-maxlength-enabled"
                            id="DEP_QUOTA_QUANTITY" min="0" name="DEP_QUOTA_QUANTITY" placeholder="จำนวนโควตา" required value="{{$dep_quota->DEP_QUOTA_QUANTITY}}">
                    </div>
                </div>
            </div>
