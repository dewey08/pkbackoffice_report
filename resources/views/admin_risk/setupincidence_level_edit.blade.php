...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">แก้ไขข้อมูลระดับความรุนแรง</h2>    

    
        <form  method="post" action="{{ route('srisk.setupincidence_level_update') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
        <div class="col-lg-2 text-right">
            ...
            <div class="col-lg-4">
            <input value="{{ $incidencelevels->INCIDENCE_LEVEL_CODE }}"  name = "INCIDENCE_LEVEL_CODE"  id="INCIDENCE_LEVEL_CODE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkrecord_code();">
    ...
    <div class="col-lg-2 text-right">
      ...
      <div class="col-lg-4">
      <input value="{{ $incidencelevels->INCIDENCE_LEVEL_NAME }}"  name = "INCIDENCE_LEVEL_NAME"  id="INCIDENCE_LEVEL_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkrecord_name();">
...
<div class="col-lg-10 ">
<textarea name="INCIDENCE_LEVEL_NAME_DETAIL" id="INCIDENCE_LEVEL_NAME_DETAIL" class="form-control input-lg time"  style=" font-family:'Kanit', sans-serif;" rows="3" onkeyup="checkrecord_name_detail();">
{{ $incidencelevels->INCIDENCE_LEVEL_NAME_DETAIL }}
...
<div style="color: red; font-size: 16px;" id="record_name_detail"></div>
    ...
    <input type="hidden" value="{{$incidencelevels->INCIDENCE_LEVEL_ID  }}"  name = "INCIDENCE_LEVEL_ID"  id="INCIDENCE_GROUPUSER_ID" class="form-control input-lg"  >

             <div class="modal-footer">
        <div align="right">
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกข้อมูล</button>
         <a href="{{ url('admin_risk/setupincidence_level')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" >ยกเลิก</a> 
         </div>    
