...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลประเภทหน่วยงาน/กลุ่มงาน</h2>    

    
        <form  method="post" action="{{ route('srisk.setupincidence_category_depart_save') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-2 text-right">
      ...
      <div class="col-lg-3">
      <input  name = "CATEGORY_DEPARTMENT_NAME"  id="CATEGORY_DEPARTMENT_NAME" class="form-control input-lg" style="font-family:'Kanit',sans-serif;font-size:14px;font-weight:normal;" onkeyup="check_cate_name();" >
...
<div style="color: red; font-size: 16px;" id="cate_subname"></div>
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกข้อมูล</button>
         <a href="{{ url('admin_risk/setupincidence_category_depart')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a> 
         </div>    
