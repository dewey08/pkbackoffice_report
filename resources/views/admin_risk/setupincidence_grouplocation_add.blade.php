...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลประเภทสถานที่</h2>    

    
        <form  method="post" action="{{ route('srisk.setupincidence_grouplocation_save') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-2 text-right">
      ...
      <div class="col-lg-10">
      <input  name = "SETUP_GROUPLOCATION_NAME"  id="SETUP_GROUPLOCATION_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"  >
      <div style="color: red; font-size: 16px;" id="record_capacity_name"></div>
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" >บันทึกข้อมูล</button>
         <a href="{{ url('admin_risk/setupincidence_grouplocation')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a> 
         </div>    
