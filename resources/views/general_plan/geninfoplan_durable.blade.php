                ...
                <table class="table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    ...
                    <?php $number++; ?>
                        ...
                        <tr height="20">
                                ...
                                <td class="text-font text-pedding" width="7%">{{$infodurable->BUDGET_NAME}}</td>
                                <td class="text-font text-pedding" width="7%" align="right">{{number_format($infodurable->DUR_ASS_PICE_UNIT,2)}}</td>
                                <td class="text-font text-pedding" width="6%" align="center">{{$infodurable->DUR_ASS_AMOUNT}}</td>
                                <td class="text-font text-pedding" width="6%" align="right">{{number_format($infodurable->DUR_PICE_SUM,2)}}</td>
                                <td class="text-font text-pedding" width="6%" align="right">{{number_format($infodurable->BUDGET_PICE_REAL,2)}}</td>
                                <td class="text-font text-pedding" width="9%">{{$infodurable->DUR_TEAM_HR_NAME}}</td>
