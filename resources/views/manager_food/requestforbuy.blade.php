    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>รายการขอซื้อขอจ้างวัสดุบริโภค
                </B></h3>
                    {{-- <div align="right">
            ...
            <form action="{{route('mfood.infofoodrequert')}}" method="post">
                @csrf
                <div class="row">
                <div class="col-sm-0.5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <span>
                                <button type="submit" class="btn btn-info f-kanit fw-1" >ค้นหา</button>
                            </span> 
                        </div>
                    </div>  
            </form>
                            ...
                            <td align="center">
                                ...
                                <div class="dropdown-menu" style="width:10px">
                                    ...
                                    <a class="dropdown-item"  href="#detail_repairnomalasset" data-toggle="modal"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;" onclick="detail({{ $inforequest -> ID}});">ตรวจสอบ</a>
                                        ...
                                        @if($checkref == 0)
                                        <a class="dropdown-item" href="{{ url('manager_food/food_purchase_register/'.$inforequest -> ID)}}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">ลงทะเบียนคุม</a>
                                        @endif
                                  
                             
                                    <a class="dropdown-item"  href="{{ url('manager_food/food_requestforbuy_edit/'.$inforequest -> ID)}}"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">รายละเอียด/แก้ไข</a>
                                    <a class="dropdown-item" href="{{ url('manager_food/food_requestforbuy_cancel/'.$inforequest -> ID)}}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">ยกเลิก</a>    
...
<div id="detail_repairnomalasset" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                            ...
                                            <div class="row">
                                            <div><h3  style="font-family: 'Kanit', sans-serif;">&nbsp;&nbsp;&nbsp;&nbsp;ตรวจสอบขอซื้อขอจ้างวัสดุบริโภค&nbsp;&nbsp;</h3></div>
                                            </div>
                                                </div>
                                                <div class="modal-body">
                                                <form  method="post" action="{{ route('mfood.mfood_inforequestverupdate') }}" enctype="multipart/form-data">
                                                @csrf  
                                                ...
                                                <div class="modal-footer">
                                                    <div align="right">
                                                    <button type="submit" name = "SUBMIT"  class="btn btn-hero-sm  btn-success f-kanit fw-1" value="approved" >ผ่าน</button>
                                                    <button type="submit"  name = "SUBMIT"  class="btn btn-hero-sm btn-danger f-kanit fw-1" value="not_approved" >ไม่ผ่านการตวจสอบ</button>
                                                    <button type="button" class="btn btn-hero-sm  btn-secondary f-kanit fw-1" data-dismiss="modal" >ปิดหน้าต่าง</button>
