...
?>
        ...
        <center>
          ...
          <div class="col-md-5" align="right">
               <a href="{{ url('manager_person/setupsetscore_add')  }}"  class="btn btn-hero-sm btn-hero-info"  ><i class="fas fa-plus"></i> เพิ่มชุดข้อมูล</a>
        ...
        <th class="text-font" style="border-color:#F0FFFF;text-align: center;"width="8%">คำสั่ง</th>
                   ...
                   <tr height="20">
                     ...
                     <td class="text-font text-pedding">{{$typescore->TYPE_SCORE_NAME}}</td>  
                     ...
                     <button type="button" class="btn btn-outline-info dropdown-toggle" id="dropdown-align-outline-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-weight:normal;">
                                                ...
                                                <div class="dropdown-menu" style="width:10px">
                                                    <a class="dropdown-item" href="{{ url('manager_person/setupsetscore_edit/'.$typescore-> TYPE_SCORE_ID )}}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;"  >แก้ไข</a>
