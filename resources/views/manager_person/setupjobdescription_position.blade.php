...
?>          
        <center>
                ...
                <div class="row">
                <div class="col-md-10">
                กำหนดข้อมูลตำแหน่ง &nbsp; {{$infojob->JOD_DIS_NAME}}
                </div>
                
             
             
               <div class="col-md-1">
               <a href="{{ url('manager_person/setupjobdescription') }}"  class="btn btn-success btn-lg"  >ย้อนกลับ</a>
        ...
        <th class="text-font"  width="5%" style="border-color:#F0FFFF;text-align: center;">ลบ</th>
                   ...
                   <tr height="40">
                     <td class="text-font"  align="center">{{ $jobposition-> JOD_POSITION_ID }} </td>                 
                     <td class="text-font text-pedding">{{ $jobposition-> JOD_POSITION_NAME }}</td> 
                   
                   
                     <td align="center">
                     <a href="{{ url('manager_person/setupjobdescriptionposition_destroy/'.$jobposition-> JOD_DIS_ID.'/'.$jobposition-> JOD_DIS_POSITION_ID)  }}" class="btn btn-danger fa fa-times" onclick="return confirm('ต้องการที่จะลบข้อมูล ?')"></a>
                     </td>   
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
        ...
        <body>
        <form  method="post" action="{{ route('mperson.setupjobdescriptionposition_save') }}" >
        @csrf
        <div class="row push">
      <div >&nbsp;</div>
      <div class="col-sm-2">
      ...
      <div class="col-sm-8">
      <select name="JOD_POSITION_ID" id="JOD_POSITION_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;">
            ...
            <input type="hidden" name="JOD_DIS_ID" id="JOD_DIS_ID" value=" {{$infojob->JOD_DIS_ID}}">
            <input type="hidden" name="idref" id="idref" value=" {{$infojob->JOD_DIS_ID}}">
