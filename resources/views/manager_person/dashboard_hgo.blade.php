...
<div class="container-fluid shadow mb-5">
    <div class="row">
        <div class="col-12">
            <br>
            <div class="card">
                <div class="card-header text-center bg-sl-gb3 py-3">
                    <h3 class="fs-24 m-0 text-white fw-3">ข้อมูลบุคลากรช่วยราชการ</h3>
                </div>
                                ...
                                <div class="tab-content d-flex justify-content-center">
                                    ...
                                    <div class="panel p-1 bg-sl-gb3">
                                            ...
                                            <div class="panel-body bg-white" style="overflow-y:hidden">
                                                <div id="HelpGovernmentOfficials_chart"
                                    ...
                                    <table id="HelpGovernmentOfficials_table" class="table-striped">
                                            <thead class="bg-sl-gb3 text-white">
                                            <tr class="">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" >{{ DateThairetire($person -> HR_BIRTHDAY) }}</td>
                                                <td class="text-center" >{{getAgeretire($person -> HR_BIRTHDAY) }}</td>
...
<script>
    ...
    $('#HelpGovernmentOfficials_table').DataTable({
        info : false,
        "iDisplayLength": 25,
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var chart = new google.visualization.ColumnChart(document.getElementById('HelpGovernmentOfficials_chart'));
