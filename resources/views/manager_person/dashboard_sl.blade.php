...
<div class="container-fluid shadow mb-5">
    <div class="row">
        <div class="col-12">
            <br>
            <div class="card">
                <div class="card-header text-center bg-sl-o2 py-3">
                    <h3 class="fs-24 m-0 text-white fw-3">ข้อมูลบุคลากรลาศึกษา</h3>
                </div>
                        ...
                        <div class="card-body">
                            <div class="container-fluit">
                                ...
                                <div class="tab-content d-flex justify-content-center">
                                    ...
                                    <table id="Studyleave_table" class="table-striped">
                                            <thead class="bg-sl-o2 text-white">
                                            <tr class="">
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var chart = new google.visualization.ColumnChart(document.getElementById('Studyleave_chart'));
