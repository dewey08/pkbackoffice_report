...
<div class="block shadow" style="width:95%;margin:10px auto 20px;">
    <div class="block-content row px-0">
        <div class="col-lg-7 mb-2">
            <div class="row">
                <div class="col-md-6">
                    <div class="dropdown dropright">
                        <button type="button" style="background:#CDF2CA;font-family: 'Kanit', sans-serif;" class=" btn dropdown-toggle" id="dropdown-dropright" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            หน่วยงาน
                        </button>
            ...
            <a class="nav-main-link{{ request()->is('person_headorg/infoleave/calender') ? ' active' : '' }}" href="{{ url('person_headorg/infoleave') }}">
                <i class="nav-main-link-icon fa fa-table"></i>
                <span class="nav-main-link-name" style="font-size: 14px;">รายละเอียดข้อมูลการลา</span>
            </a>
            <div class="panel bg-sl p-1" style="background-color: #32CD32">
        ...
        <br><br><br>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card p-1 mx-0" style="background-color: #32CD32">
