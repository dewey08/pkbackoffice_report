...
<div style='overflow:scroll; width:auto;height:900px;  background-color: #404040;' id="pages"></div>
   ...
   วันที่บันทึก  {{$datenow}}
        ...
        <div class="row">
            ...
            <input  name = "BOOK_NUM_IN"  id="BOOK_NUM_IN" class="form-control input-sm {{ $errors->has('BOOK_NUM_IN') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{$maxnumberuse}}" readonly>
            </div>
            <div class="col-md-3">
