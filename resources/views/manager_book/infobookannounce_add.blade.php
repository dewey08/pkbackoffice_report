...
<h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ลงรับประกาศ</B></h3>

</div>
<form  method="post" action="{{ route('mbook.infobookannouncesave') }}"  enctype="multipart/form-data"  class="needs-validation" novalidate>      
    @csrf
...
<div style='overflow:scroll; width:auto;height:500px;  background-color: #404040;' id="pages"></div>
   ...
   วันที่บันทึกรับ  {{$datenow}}
           ...
           <!--   <div class="col">
            ...
            <div class="col-md-3">
            <input  name = "BOOK_NUM_IN"  id="BOOK_NUM_IN" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
            </div>-->
            <div class="col-md-3">
       ...
       <!-- <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
            <input  name = "TIME_SAVE"  id="TIME_SAVE" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{date('H:i')}}">
            </div>
        </div>
       ...
       <!-- <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
            <select name="BOOK_TYPE_ID" id="BOOK_TYPE_ID" class="form-control input-sm js-example-basic-single" style=" font-family: 'Kanit', sans-serif;" onchange="checkdatebegin();checkdateend();checkall();">
