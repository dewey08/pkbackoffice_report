    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>รายการการยืมคืน - คืน</B></h3>
                    <div align="right">
                          <a href="{{ url('manager_supplies/requestforbuy_add')  }}"   class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-plus"></i> เพิ่มข้อมูลรายการ</a> 
                    </div>
            </div>
