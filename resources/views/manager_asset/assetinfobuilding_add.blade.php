                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="BUILD_NAME" id="BUILD_NAME" class="form-control input-lg"
                                    style=" font-family: 'Kanit', sans-serif;font-size: 14px;" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input name="BUILD_NGUD_MONEY" id="BUILD_NGUD_MONEY" class="form-control input-lg"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input name="TOTAL" id="TOTAL" class="form-control input-lg"
                                    style=" font-family: 'Kanit', sans-serif;"  OnKeyPress="return chkmunny(this)" value="" required>
                            </div>
                            <div class="col">
                                <p style="text-align: left">อายุการใช้งาน</p>
                            </div>
                            <div class="col-md-3">
                                <input name="OLD_USE" id="OLD_USE" class="form-control input-lg"
                                    style=" font-family: 'Kanit', sans-serif;"  OnKeyPress="return chkmunny(this)" value="" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input name="BUILD_CREATE" id="BUILD_CREATE" class="form-control input-lg datepicker"
                                    style=" font-family: 'Kanit', sans-serif;" data-date-format="mm/dd/yyyy" readonly required>
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="BUILD_HR_TEL" id="BUILD_HR_TEL" class="form-control input-lg "
                                    style=" font-family: 'Kanit', sans-serif;" value="" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="ENGINEER_NAME" id="ENGINEER_NAME" class="form-control input-lg"
                                    style=" font-family: 'Kanit', sans-serif;" value="" required>
                            </div>
