                    ...
                    <div class="card-body shadow-lg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 text-end">
                                <button type="button" class="btn-icon btn-shadow btn-dashed btn btn-outline-info Savestamp" data-url="{{url('stayed_down_opd_stam')}}">
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, pull it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('acc.stayed_down_opd_pulldata') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
