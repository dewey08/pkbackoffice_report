    ...
    <div class="content mx-1 ml-3">
        ...
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title foo15" style="font-family: 'Kanit', sans-serif;"><B>บัญชีความเสี่ยง</B></h3>
                <a href=""
                class="btn btn-hero-sm btn-hero-primary foo15"><i class="fas fa-plus mr-2"></i> เพิ่มจากกระบวนการ</a>
                &nbsp;
                <a href=""
                    class="btn btn-hero-sm btn-hero-primary foo15"><i class="fas fa-plus mr-2"></i> เพิ่มความเสี่ยง</a>
            </div>
                    ...
                    <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                        ...
                        <tbody>
                                ...
                                <tr height="40">                       
                                    ...
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >ด้านการดำเนินงาน</td>
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >ข้อมูลสิทธิการรักษาผู้ป่วยไม่ถูกต้อง</td>
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >จัดประชุมชี้แจง จนท.ที่เกี่ยวข้อง</td>
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >ควบคุมควมเสี่ยง</td>
                                    ...
                                    <td align="center" width="5%">
                                        <div class="dropdown ">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">  
                                                <a class="dropdown-item"  href="{{ url('general_risk/risk_notify_account_detail/1/'.$inforpersonuserid->ID)  }}" style="font-family: 'Kanit', sans-serif; font-size: 13px;"><i class="fas fa-info-circle text-info mr-2"></i>แก้ไขรายการความเสี่ยง</a> 
