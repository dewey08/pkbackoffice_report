    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>แก้ไขรายละเอียดการทบทวน</B></h3>   
                
                </div> 
            <div class="block-content block-content-full " align="left">


<form  method="post" action="{{ route('gen_risk.risk_notify_repeat_sub_u_update') }}" enctype="multipart/form-data">
@csrf
...
<div class="col-sm-1">
    ...
    <div class="row push">
        ...
        <div class="col-lg-2 ">
            <input value="{{ $notify_repeats->NOTIFY_REPEAT_NO}}" name="NOTIFY_REPEAT_NO" id="NOTIFY_REPEAT_NO" class="form-control input-sm">
        </div>
        <div class="col-sm-2 ">        
            <label>วันที่ทบทวน :</label>
        </div> 
        <div class="col-lg-2 ">
            <input value="{{ formate($notify_repeats->NOTIFY_REPEAT_DATE)}}" name="NOTIFY_REPEAT_DATE" id="NOTIFY_REPEAT_DATE" class="form-control input-sm datepicker" data-date-format="mm/dd/yyyy" readonly>
...
<div class="modal-footer">
    ...
    <a href="{{ url('general_risk/risk_notify_repeat_u/'.$rigreps->RISKREP_ID.'/'.$inforpersonuserid -> ID)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a>
    </div>  
    </div>
