                        ...
                        <tbody>
                            ...
                            @foreach ($rigreps as $rigrep)
                                ...
                                <tr  height="20">
                                    ...
                                    <td class="text-font text-pedding" align="center" style="vertical-align: top;" width="4%">{{$rigrep->RISKREP_NO}}</td>
                                    ...
                                    <td class= "text-pedding" style="vertical-align: top;" align="center" width="9%"><a href="{{route('gen_risk.risk_notify_recheck',[$rigrep->RISKREP_ID,$inforpersonuserid->ID])}}" class="btn btn-hero-sm btn-hero-warning"><i class="fa fa-file-signature"></i></a>
                                    </td>
