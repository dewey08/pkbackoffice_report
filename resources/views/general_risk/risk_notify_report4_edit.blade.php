...
@section('content')
    ...
    <div class="content mx-1 ml-3">
        ...
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title foo15" style="font-family: 'Kanit', sans-serif;"><B>รายละเอียด/แก้ไขข้อมูล รายงาน ปค.4</B></h3>
            ...
            <div class="block-content">
                ...
                <form method="post" action="{{ route('gen_risk.risk_notify_report4_update') }}" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="row push">
            ...
            <div class="col-lg-2 ">
                <input type="text" name="RISK_NOTIFY_RE4_YEAR" id="RISK_NOTIFY_RE4_YEAR" value="{{$infore4->RISK_NOTIFY_RE4_YEAR}}" class="form-control input-sm " >               
            </div> 
            ...
            <div class="col-sm-2">
                ...
                <div class="col-lg-2 "> 
                <input name="RISK_NOTIFY_RE4_BEGINDATE" id="RISK_NOTIFY_RE4_BEGINDATE" value="{{formate($infore4->RISK_NOTIFY_RE4_BEGINDATE)}}" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy" style="font-family:'Kanit',sans-serif;font-size:13px;" readonly>          
                ...
                <div class="col-sm-1">
                    ...
                    <div class="col-lg-3 "> 
                        <input name="RISK_NOTIFY_RE4_ENDDATE" id="RISK_NOTIFY_RE4_ENDDATE"  value="{{formate($infore4->RISK_NOTIFY_RE4_ENDDATE)}}" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy" style="font-family:'Kanit',sans-serif;font-size:13px;"  readonly>          
                    </div> 
                </div> 
                ...
                <div class="row push">
                            ...
                            <div class="col-lg-2 ">
                                ...
                                @foreach($infomationdeps as $infomationdep)
                                        @if($infomationdep->HR_DEPARTMENT_SUB_SUB_ID == $infore4->RISK_NOTIFY_RE4_DEP)

                                        <option value="{{ $infomationdep->HR_DEPARTMENT_SUB_SUB_ID}}" selected>{{ $infomationdep->HR_DEPARTMENT_SUB_SUB_NAME}} </option>
                                        @else
                            ...
                            <div class="col-lg-2 ">
                                <select name="RISK_NOTIFY_RE4_PERSON" id="RISK_NOTIFY_RE4_PERSON" value="{{$infore4->RISK_NOTIFY_RE4_PERSON}}" class="form-control input-lg fo13" required>
                                    <option value="">--เลือก--</option>
                                    @foreach ($infomationpersons as $infomationperson) 
                                    @if($infomationperson ->ID  == $infore4->RISK_NOTIFY_RE4_PERSON)  
                                    <option value="{{ $infomationperson ->ID  }}" selected>{{ $infomationperson->HR_FNAME}} {{ $infomationperson->HR_LNAME}}</option>
                                    @else
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_ENV" id="RISK_NOTIFY_RE4_ENV" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_ENV}}</textarea>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_RESULTENV" id="RISK_NOTIFY_RE4_RESULTENV" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_RESULTENV}}</textarea>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_RATE" id="RISK_NOTIFY_RE4_RATE" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_RATE}}</textarea>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_RESULTRATE" id="RISK_NOTIFY_RE4_RESULTRATE" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_RESULTRATE}}</textarea>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_ACT" id="RISK_NOTIFY_RE4_ACT" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_ACT}}</textarea>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_RESULTACT" id="RISK_NOTIFY_RE4_RESULTACT" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_RESULTACT}}</textarea>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_IT" id="RISK_NOTIFY_RE4_IT" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_IT}}</textarea>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_RESULTIT" id="RISK_NOTIFY_RE4_RESULTIT" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_RESULTIT}}</textarea>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_TAG" id="RISK_NOTIFY_RE4_TAG" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_TAG}}</textarea>
        ...
        <div class="row push">
            ...
            <div class="col-lg-10 ">
                <textarea name="RISK_NOTIFY_RE4_RESULTTAG" id="RISK_NOTIFY_RE4_RESULTTAG" class="form-control input-lg" rows="10" >{{$infore4->RISK_NOTIFY_RE4_RESULTTAG}}</textarea>
    ...
    <a href="{{ url('general_risk/risk_notify_report4/'.$inforpersonuserid -> ID)  }}"  class="btn btn-hero-sm btn-hero-danger"  ><i class="fas fa-window-close mr-2"></i>ยกเลิก</a>
    </div>
