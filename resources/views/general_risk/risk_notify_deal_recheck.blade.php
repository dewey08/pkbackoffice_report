    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-details">
                <a href="{{route('gen_risk.risk_notify_deal_recheck_add',[$riskid,$iduser])}}"
                    class="btn btn-info"
                    style="font-family: 'Kanit', sans-serif;font-weight:normal;"><i class="fas fa-plus"></i>
                    เพิ่มข้อมูล</a>
                <a class="btn btn-success" href="{{ route('gen_risk.risk_notify_deal',$iduser) }}"><i
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" style="width:10px">
                                        <a class="dropdown-item"
                                            href="{{route('gen_risk.risk_notify_deal_recheck_edit',[$inforecheck->RISK_RECHECK_ID,$iduser])}}"
