...
<form  method="post" action="{{route('gen_risk.risk_notify_repeat_sub_u_save')}}" enctype="multipart/form-data">
@csrf
...
<div class="row push">
        ...
        <div class="col-lg-2 ">
            <input  name="NOTIFY_REPEAT_NO" id="NOTIFY_REPEAT_NO" class="form-control input-sm" required>
        </div>
        <div class="col-sm-2 ">        
            ...
            <div class="tab-pane" id="object3" role="tabpanel">
                <table class="table gwt-table" >
                    ...
                    <tbody class="tbody3">
                        <tr>                            
                            <td >                              
                                    <select name="BOARD_ID[]" id="BOARD_ID" class="form-control input-lg js-example-basic-single" style=" font-family: 'Kanit', sans-serif;font-size:13px;" >
                                        <option value="" selected>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                     
                                            -- กรุณาเลือกคณะกรรมการ --
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </option>   
                ...
                <table class="table gwt-table" >
                    ...
                    <tbody class="tbody4">
                        <tr> 
                            ...
                            <td>
                                <input name="BOARD_OUT_FNAME[]" id="BOARD_OUT_FNAME[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;font-size:13px;" required>
                            </td>
                            <td>
...
<div class="modal-footer">
    ...
    <a href="{{ url('general_risk/risk_notify_detail/'.$rigreps->RISKREP_ID.'/'.$inforpersonuserid -> ID)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a>
    </div>  
    </div>
