...
?>   
                    ...
                    <div class="content">
                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                            ...
                            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                                ...
                                <div>&nbsp;</div>
                                <div>
                                <a href="{{ url('general_risk/risk_refdepsubsub/'.$inforpersonuserid -> ID)}}" class="btn btn-success " >อ้างอิงหน่วยงาน</a>
                                </div>
                                <div>&nbsp;</div>
                                <div>
                ...
                <div class="content">
                        ...
                        <div class="block-header block-header-default">
                            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ข้อมูลความเสี่ยงอ้างอิงหน่วยงาน</B></h3>
                        </div>
                        <div class="block-content block-content-full">
                            <form action="{{ route('gen_risk.risk_refdepsubsub_search',['iduser'=>  $inforpersonuserid->ID]) }}" method="post">
                                @csrf
