    ...
    <div class="content mx-1 ml-3">
        ...
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title foo15" style="font-family: 'Kanit', sans-serif;"><B>ภาระกิจ การใช้รถยนต์ของทางราชการ</B></h3>
                <a href=""
                    class="btn btn-hero-sm btn-hero-primary foo15"><i class="fas fa-plus mr-2"></i> เพิ่มข้อมูลกระบวนการ</a>
            </div>
                    ...
                    <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                        <thead style="background-color: #FFEBCD;">
                            <tr height="40">
                                ...
                                <th  class="text-font" style="text-align: center;font-size: 13px;" >ปีงบประมาณ</th>
                                <th  class="text-font" style="text-align: center;font-size: 13px;" >รอบ</th> 
                                <th  class="text-font" style="text-align: center;font-size: 13px;" >ครั้งที่</th>
                                <th  class="text-font" style="text-align: center;font-size: 13px;" >เจ้าหน้าที่</th>                            
                        ...
                        <tbody>
                                ...
                                <tr height="20">                       
                                    <td class="text-font" style="text-align: center;font-size: 13px;" align="center">1</td>
                                 
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >2564</td>
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >6 เดือน</td>
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >1</td>
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >จิตสง่า เพชรสุวรรณ</td>
                                    ...
                                    <td align="center" width="5%">
                                        <div class="dropdown ">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">   
                                                ...
                                                <a class="dropdown-item"  href="{{ url('general_risk/risk_notify_analysis/' . $inforpersonuserid->ID.'/1') }}" style="font-family: 'Kanit', sans-serif; font-size: 13px;"><i class="fas fa-info-circle text-info mr-2"></i>วิเคราะห์ความเสี่ยง</a> 
                                ...
                                <tr height="20">                       
                                    <td class="text-font" style="text-align: center;font-size: 13px;" align="center">2</td>
                                 
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >2564</td>
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >12 เดือน</td>
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >1</td>
                                    <td class="text-font text-pedding" style="text-align: center;font-size: 13px;" >จิตสง่า เพชรสุวรรณ</td>
                                    ...
                                    <td align="center" width="5%">
                                        <div class="dropdown ">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">   
                                                ...
                                                <a class="dropdown-item"  href="{{ url('general_risk/risk_notify_analysis/' . $inforpersonuserid->ID.'/2') }}" style="font-family: 'Kanit', sans-serif; font-size: 13px;"><i class="fas fa-info-circle text-info mr-2"></i>วิเคราะห์ความเสี่ยง</a> 
