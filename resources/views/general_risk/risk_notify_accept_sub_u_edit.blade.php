    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>แก้ไขรายละเอียดการตอบรับ</B></h3>   
               
                </div> 
            <div class="block-content block-content-full " align="left">

<form  method="post" action="{{ route('gen_risk.risk_notify_accept_sub_u_update') }}" enctype="multipart/form-data">
@csrf
...
<div class="row push">
    ...
    <div class="col-lg-2 "> 
        <input value="{{ $notify_accepts-> NOTIFY_ACCEPT_NO}}" name="NOTIFY_ACCEPT_NO" id="NOTIFY_ACCEPT_NO" class="form-control input-sm" >
...
<div class="row push">
    ...
    <div class="col-lg-3 ">        
        <input value="{{ $notify_accepts-> NOTIFY_ACCEPT_ABOUT}}" name = "NOTIFY_ACCEPT_ABOUT"  id="NOTIFY_ACCEPT_ABOUT" class="form-control input-lg" style="font-family:'Kanit',sans-serif;font-size:13px;font-weight:normal;">
    </div>
    <div class="col-sm-1"> 
        <label>รายละเอียด :</label>
    </div> 
    <div class="col-lg-6 ">        
        <textarea name="NOTIFY_ACCEPT_DETAIL" id="NOTIFY_ACCEPT_DETAIL" rows="4" class="form-control input-lg" style="font-family:'Kanit',sans-serif;font-size:13px;font-weight:normal;">{{ $notify_accepts-> NOTIFY_ACCEPT_DETAIL}}</textarea>
    </div>
</div>
...
<div class="modal-footer">
    ...
    <a href="{{ url('general_risk/risk_notify_accept_u/'.$rigreps->RISKREP_ID.'/'.$inforpersonuserid -> ID ) }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a>
    </div>  
    </div>
