...
<div class="bg-body-light">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
             <h1 style="font-family: 'Kanit', sans-serif; font-size:15px;font-size: 1.5rem;font-weight:normal;">{{ $inforpersonuser -> HR_PREFIX_NAME }}   {{ $inforpersonuser -> HR_FNAME }}  {{ $inforpersonuser -> HR_LNAME }}</h1> 
                ...
                <div class="row">
                                            ...
                                            <div>
                                             <a href="{{ url('general_launder/withdraw_launder/'.$inforpersonuserid -> ID) }}" class="btn btn-info" >เช็คสต๊อค-เบิกผ้า
    ...
    <div class="block block-rounded block-bordered">
        ...
        <br>
<form  method="post" action="{{ route('gen_launder.withdrowlaunder_save') }}" enctype="multipart/form-data">
@csrf
      ...
      <input type="hidden" name="LAUNDER_WITHDROW_HR_ID" id="LAUNDER_WITHDROW_HR_ID" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value=" {{$inforpersonuserid->ID}}">
       ...
       <table class="gwt-table table-striped table-vcenter " style="width: 100%;">
        ...
        <a href="{{ url('general_launder/withdraw_launder/'.$inforpersonuserid->ID)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการขอเบิก ?')" >ยกเลิก</a>
        </div>
