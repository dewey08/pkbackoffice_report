...
$refpay = LaunderController::refpay();
...
<div class="bg-body-light">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
             ...
             <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                ...
                <div class="row">
                                            ...
                                            <div>
                                             <a href="{{ url('general_launder/pay_launder/'.$inforpersonuserid -> ID) }}" class="btn btn-primary" >จ่ายผ้า
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>จ่ายผ้า| หน่วยงาน</B></h3>
            <br>
        </div>
        <br>
<form  method="post" action="{{ route('gen_launder.pay_launder_save') }}" enctype="multipart/form-data">
@csrf
        ...
        <div class="col-lg-2">
        <input name="LAUNDER_PAY_CODE" id="LAUNDER_PAY_CODE" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$refpay}}">
        </div> 
        <div class="col-lg-1" style="text-align: left">
        <label >                           
                            วันที่ :              
        ...
        <div class="col-lg-2">
        <input name="LAUNDER_PAY_DATE" id="LAUNDER_PAY_DATE" class="form-control input-sm datepicker" style=" font-family: 'Kanit', sans-serif;" value="{{formate($date)}}" readonly>
        </div> 
        <div class="col-lg-1" style="text-align: left">
        <label>                           
                            เหตุผล:              
        ...
        <div class="col-lg-4" >
        <input name="LAUNDER_PAY_COMMENT" id="LAUNDER_PAY_COMMENT" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
        </div> 
        </div>
      ...
      <input type="hidden" name="LAUNDER_PAY_SAVE_HR_ID" id="LAUNDER_PAY_SAVE_HR_ID" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value=" {{$inforpersonuserid->ID}}">
      <input type="hidden"  name="LAUNDER_PAY_SAVE_HR_NAME" id="LAUNDER_PAY_SAVE_HR_NAME" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$inforpersonuser->HR_FNAME}} {{$inforpersonuser->HR_LNAME}}">
        ...
        <input type="hidden" name="LAUNDER_PAY_TREASURT_NAME" id="LAUNDER_PAY_TREASURT_NAME" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$inforpersonuser->HR_DEPARTMENT_SUB_SUB_NAME}}">
        <input type="hidden" name="LAUNDER_PAY_DEP" id="LAUNDER_PAY_DEP" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$inforpersonuser->HR_DEPARTMENT_SUB_SUB_ID}}">
       ...
       <table class="gwt-table table-striped table-vcenter " style="width: 100%;">
        ...
        <a href="{{ url('general_launder/pay_launder/'.$inforpersonuserid->ID)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการจ่ายผ้า ?')" >ยกเลิก</a>
        </div>
