...
<div class="bg-body-light">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            {{-- <a href="{{ url('general_launder/pay_launder_add/'.$inforpersonuserid -> ID)}}"  class="btn btn-info" ><i class="fas fa-plus"></i> เพิ่มการจ่ายผ้า</a> --}}
        </div>
        <div class="block-content block-content-full">
        <form action="{{ route('gen_launder.pay_laundersearch',[ 'iduser'=>$inforpersonuserid->ID ]) }}" method="post">
                @csrf
                <div class="row">
                ...
                <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    <thead style="background-color: #FFEBCD;">
                        ...
                        <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="5%">ลำดับ</th>
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >ผู้จ่ายผ้า</th>
                    ...
                    <td class="text-font" align="center">{{$number}}</td>
                        ...
                        <td class="text-font text-pedding" >{{$infopay->LAUNDER_PAY_CODE}}</td>
                        <td class="text-font text-pedding" >{{DateThai($infopay->LAUNDER_PAY_DATE)}}</td>
                        <td class="text-font text-pedding" >{{$infopay->LAUNDER_PAY_COMMENT}}</td>
                        <td class="text-font text-pedding" >{{$infopay->LAUNDER_PAY_SAVE_HR_NAME}}</td>
                        <td class="text-font text-pedding" >{{$infopay->LAUNDER_PAY_TREASURT_NAME}}</td>
                        ...
                        <button type="button" class="btn btn-outline-info dropdown-toggle" id="dropdown-align-outline-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-weight:normal;">
                                ...
                                <a class="dropdown-item" href="#detail_appall" data-toggle="modal" style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;" >รายละเอียด</a>
