...
<center>    
    <div class="block mt-5" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            ...
            <form action="{{ route('mcompensation.infosalaryslip') }}" method="post">
                @csrf
                    ...
                    <?php $number = 0; ?>
                                ...
                                <?php $number++; ?>
                                    ...
                                    <tr height="40">
                                        ...
                                        @elseif($inforSalaryslip->CER_STATUS == 'NOTSUCCESS')
                                        ...
                                        @endif
                                        <td class="text-font text-pedding">{{ $inforSalaryslip->SLIP_NUMBER}}</td>
                                        <td class="text-font text-pedding" style="text-align: center;">{{ $inforSalaryslip->SLIP_YEAR}}</td>
                                        <td class="text-font text-pedding">{{ DateThai($inforSalaryslip->SLIP_DATE)}}</td>
                                        
                                        <td class="text-font text-pedding">{{ $inforSalaryslip->SLIP_COMMENT}}</td>
                                        <td class="text-font text-pedding">{{ $inforSalaryslip->SLIP_HR_DEP_SUB_SUB_NAME}}</td>
                                        <td class="text-font text-pedding">{{ $inforSalaryslip->SLIP_HR_PERSON_NAME}}</td>
                                        ...
                                        <button type="button" class="btn btn-outline-info dropdown-toggle" id="dropdown-align-outline-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;">
                                                ...
                                                <a class="dropdown-item"  href="#detail{{ $inforSalaryslip -> SLIP_ID }}"  data-toggle="modal" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">รายละเอียด</a>
                                                <a class="dropdown-item"  href="{{ url('manager_compensation/infopersonsalarydetail/'.$inforSalaryslip->SLIP_HR_PERSON_ID)  }}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;"  >ข้อมูลเงินเดือน</a>
                                               
                                                @if($inforSalaryslip->SLIP_STATUS== 'REQUEST')
                                                <a class="dropdown-item"  href="#lastapp_modal{{ $inforSalaryslip -> SLIP_ID }}"  data-toggle="modal" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">อนุมัติ</a>
                                                @endif
                                                </div>
                                        </div>
                                        </td>     
                                ...
                                <!------------------------รายละเอียด------------------------------------------>
                                <div id="detail{{ $inforSalaryslip -> SLIP_ID}}" class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                         <div class="modal-dialog modal-xl">
                                         <div class="modal-content">
                                         <div class="modal-header">

                                    <h2 class="modal-title" style="font-family: 'Kanit', sans-serif; font-size:15px;font-size: 1.5rem;font-weight:normal;">อนุมัติข้อมูลการขอสลิปเงินเดือนเลขที่ {{ $inforSalaryslip -> SLIP_ID}}</h2>
                                        </div>
                                        <div class="modal-body">
                                        <div class="row">

                                            <form  method="post" action="{{ route('mcompensation.updatesliplastapp') }}" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden"  name="ID" value="{{ $inforSalaryslip -> SLIP_ID}}"/>
                                                            ...
                                                            <div class="col-sm-2">
                                                                ...
                                                                <div class="col-lg-2">        
                                                                <h1 style="font-family: 'Kanit', sans-serif; font-size:10px;font-size: 1.0rem;font-weight:normal;color:#778899;">{{ $inforSalaryslip -> SLIP_NUMBER }}</h1>       
                                                                </div>
                                                                <div class="col-sm-2 text-right">
                                                                    <label>ลงวันที่ต้องการ :</label>
                                                                </div> 
                                                                <div class="col-lg-2"> 
                                                                <h1 style="font-family: 'Kanit', sans-serif; font-size:10px;font-size: 1.0rem;font-weight:normal;color:#778899;">{{ DateThai($inforSalaryslip -> SLIP_DATE) }}</h1>         
                                                                ...
                                                                <div class="col-lg-2">        
                                                                <h1 style="font-family: 'Kanit', sans-serif; font-size:10px;font-size: 1.0rem;font-weight:normal;color:#778899;">{{ $inforSalaryslip -> SLIP_YEAR }}</h1>         
                                                            ...
                                                            <div class="row push">
                                                                ...
                                                                {{ $inforSalaryslip -> SLIP_HR_PERSON_NAME }}</h1> 
                                                                ...
                                                                <div class="col-sm-2">
                                                                    ...
                                                                    <h1 style="font-family: 'Kanit', sans-serif; font-size:10px;font-size: 1.0rem;font-weight:normal;color:#778899;">{{ $inforSalaryslip -> SLIP_POSITION_IN_WORK }}</h1>
                                                                ...
                                                                <div class="col-sm-2">
                                                                <h1 style="font-family: 'Kanit', sans-serif; font-size:10px;font-size: 1.0rem;font-weight:normal;color:#778899;">
                                                                {{ $inforSalaryslip -> SLIP_HR_LEVEL_NAME }}</h1>
                                                                </div> 
                                                            ...
                                                            <div class="row push">
                                                                ...
                                                                <div class="col-sm-2">
                                                                <h1 style="font-family: 'Kanit', sans-serif; font-size:10px;font-size: 1.0rem;font-weight:normal;color:#778899;">{{ $inforSalaryslip -> SLIP_MOUNT }}</h1>
                                                            ...
                                                            <div class="row push">
                                                                ...
                                                                <div class="col-lg-2"> 
                                                                <h1 style="font-family: 'Kanit', sans-serif; font-size:10px;font-size: 1.0rem;font-weight:normal;color:#778899;"> {{ DateThai($inforSalaryslip -> SLIP_START_DATE) }} </h1>       
                                                                ...
                                                                <div class="col-lg-2"> 
                                                                <h1 style="font-family: 'Kanit', sans-serif; font-size:10px;font-size: 1.0rem;font-weight:normal;color:#778899;">{{ DateThai($inforSalaryslip -> SLIP_END_DATE) }}</h1>       
                                                            ...
                                                            <div class="row push">
                                                                ...
                                                                <div class="col-sm-10">
                                                                <h1 style="font-family: 'Kanit', sans-serif; font-size:10px;font-size: 1.0rem;font-weight:normal;color:#778899;">{{ $inforSalaryslip -> SLIP_COMMENT }}</h1>
                            ...
                            <div id="lastapp_modal{{ $inforSalaryslip -> SLIP_ID}}" class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                         <div class="modal-dialog modal-xl">
                                         <div class="modal-content">
                                         <div class="modal-header">
