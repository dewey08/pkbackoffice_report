        ...
        <form action="{{ route('acc.account_603_dash') }}" method="GET">
            ...
            <div class="row">
                ...
                <div class="col-md-2 text-start">
                    ...
                    <a href="{{url('account_603_pull')}}" class="mb-2 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary" target="_blank">
                                        ...
                                        <div class="flex-grow-1 ">
                                            <?php
                                                ...
                                                $sumapprove_ = DB::select('
                                                        SELECT count(DISTINCT U1.vn) as Apvit ,sum(U2.payprice) as payprice
                                                            ...
                                                            LEFT JOIN acc_stm_prb U2 ON U2.acc_1102050102_602_sid = U1.acc_1102050102_603_id  
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 text-end me-4">
                                                    <a href="{{url('account_603_stmnull_all/'.$item->months.'/'.$item->year)}}" target="_blank">
                                                        <div class="widget-chart widget-chart-hover">
