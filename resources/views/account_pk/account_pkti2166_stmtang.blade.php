            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header"> 
                       รายละเอียดตั้งลูกหนี้ผัง 1102050101.2166 ส่วนต่าง
                                ...
                                @foreach ($data as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-center" width="8%">{{ $item->vn }}</td> 
                                                ...
                                                <td class="text-end" style="color:rgb(9, 196, 180)" width="8%">{{ number_format($item->price_approve,2)}}</td>  
                                        ...
                                        <?php
                                            ...
                                            $total3 = $total3 + $item->price_approve;
                                        ?>
