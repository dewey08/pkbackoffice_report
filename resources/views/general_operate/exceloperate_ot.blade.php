...
header('Content-Disposition: attachment; filename="Operate_OT.xls"');//ชื่อไฟล์
...
<body>
                ...
                <center>
                <B>สรุปข้อมูลตารางเวรทำงานล่วงเวลา<br>ประจำเดือน {{Monththai($operateindexinfo->OPERATE_INDEX_MONTH)}}   ปี พ.ศ. {{Yearthai($operateindexinfo->OPERATE_INDEX_YEAR)}}  หน่วยงาน {{$operateindexinfo->HR_DEPARTMENT_SUB_SUB_NAME}} </B>      
                </center>
                <br>  
                       ...
                       <table border="1" style="border-color: #000000;"  width="100%">
                          ...
                          <td class="text-pedding text-font">{{ $infoactivity->OPERATE_MEMBER_POSITION_NAME }}</td>
                                   ...
                                   @foreach ($operatejobs as $operatejob)
                                       <?php 
                                           ...
                                           if($infoactivity->DATE_1 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                                               $DATE_1 = $operatejob->OPERATE_JOB_NAME;
                                               $color_1 = $operatejob->OPERATE_JOB_COLOR;
                                               $total = $total+$operatejob->OPERATE_JOB_MONEY;
                                               break;
                                           }else{
                                               $DATE_1='';
                                               $color_1 ='';       
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_2 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach  
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_3 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_4 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_5 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_6 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_7 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_8 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_9 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_10 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_11 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_12 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_13 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_14 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_15 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_16 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_17 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_18 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_19 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_20 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                            ...
                            @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_21 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_22 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_23 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_24 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_25 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_26 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_27 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_28 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_29 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach   
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_30 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          @endforeach  
                           ...
                           @foreach ($operatejobs as $operatejob)
                                <?php 
                                   if($infoactivity->DATE_31 == $operatejob->OPERATE_JOB_ID && $operatejob->OPERATE_JOB_TYPE_ID== '2'){
                          ...
                          <td class="text-font" align="center" bgcolor="{{ $color_31 }}">{{number_format($total)}}</td>
                          </tr>
                          <?php 
                          $totalsum[$number] = $total;
                          $sumtotal = array_sum($totalsum) ; ?>
                          @endforeach 
                          <tr>
                          <td colspan="34" class="text-font" align="center" bgcolor="#FFFFF0">รวมเป็นจำนวนเงิน</td>
                          <td class="text-font" align="center" bgcolor="">{{number_format($sumtotal)}}</td>
                          </tr>
