...
<center>    
    <div class="block" style="width: 95%;">
        ...
        <input  type="hidden" name="PRO_TYPE" id="PRO_TYPE" value="team">
        ...
        <div class="col-lg-2">
        <input name="PRO_NUMBER" id="PRO_NUMBER" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  >
        </div>
        ...
        <div class="col-lg-3">
        <select name="PLAN_TYPE_ID" id="PLAN_TYPE_ID" class="form-control input-sm"  style=" font-family: 'Kanit', sans-serif;">   
        ...
        <div class="col-lg-4">
        <select name="PRO_TEAM_NAME" id="PRO_TEAM_NAME" class="form-control input-sm"  style=" font-family: 'Kanit', sans-serif;">   
        <option value="">กรุณาเลือกแผนงาน</option>                         
        ...
        <div class="col-lg-4">
        <select name="PRO_TEAM_HR_ID" id="PRO_TEAM_HR_ID" class="form-control input-sm"  style=" font-family: 'Kanit', sans-serif;">   
        ...
        <div class="col-lg-4">
        <input name="PRO_COMMENT" id="PRO_COMMENT" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  >
        </div> 
       ...
       <br>
        ...
        <a href="{{ url('manager_plan/project')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a>
        </div>
