              ...
              <input type="hidden" name="COR_RESULT_PERSON_ID" id="COR_RESULT_PERSON_ID" value="{{$infoperson->ID}}">
                  ...
                  <div class="row">    
                        ...
                        <select  name="FUN_RESULT_YEAR" id="FUN_RESULT_YEAR"  class="form-control" id="exampleFormControlSelect1">
                          ...
                          @if($infocorresult->FUN_RESULT_YEAR == '2563'  )<option value="2563" selected>2563</option>@else<option value="2563">2563</option>@endif
                          @if($infocorresult->FUN_RESULT_YEAR == '2562'  )<option value="2562" selected>2563</option>@else<option value="2562">2562</option>@endif
                        ...
                        @if($infocorresult->FUN_RESULT_NO == '1'  )<option value="1" selected>1</option>@else<option value="1">1</option>@endif
                        @if($infocorresult->FUN_RESULT_NO == '2'  )<option value="2" selected>2</option>@else<option value="2">2</option>@endif
                                          ...
                                          <tr height="20">
                                            ...
                                            <select  name="SCORE_ID[]" id="SCORE{{$idhead}}{{$number}}" class="form-control" onchange="checkscore({{$idhead}},{{$number}},{{$count}})" >
                                              <option value="0">กรุณาเลือก</option>
                                                ...
                                                @if($infofunresultsub->SCORE_ID == $infoworktypescoresub->TYPE_SCORE_SUB_ID)  
                                            ...
                                            <td class="text-font text-pedding"><input name="COMMENT[]" id="COMMENT" class="form-control" value="{{$infofunresultsub->COMMENT}}"></td> 
                                          </tr> 
