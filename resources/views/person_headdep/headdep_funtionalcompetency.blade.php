    ...
    <div class="block" style="width: 95%;">
        <div class="block-content">
            <div class="block-header block-header-default">
                ...
                <a href="{{ url('person_headdep/headdep_funtionalcompetency_add/'.$infoperson->ID)}}"  class="btn btn-hero-sm btn-hero-info"  >ประเมิน</a>
                &nbsp;&nbsp;
     ...
     <tr height="20">
             ...
             <td align="center">
                         <div class="dropdown">
                             ...
                             <a class="dropdown-item" href="{{ url('person_headdep/headdep_funtionalcompetency_detail/'.$infoperson->ID.'/'.$corecompetency->FUN_RESULT_ID)}}"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;" >รายละเอียด</a>   
