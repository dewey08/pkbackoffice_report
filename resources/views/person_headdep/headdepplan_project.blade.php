    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                ...
                <a href="{{ url('person_headdep/project_add') }}"   class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-plus"></i> เพิ่มข้อมูล</a>
            </div>
                ...
                <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    <thead style="background-color: #FFEBCD;">
                        <tr height="40">
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >	เป้าประสงค์	</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >	ตัวชี้วัด	</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >	ประเภทโครงการ	</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >	ชื่อแผนงาน/โครงการ	</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >	เป้าหมาย	</th>
                    ...
                    <?php $number++; ?>
                        ...
                        <tr height="20">
                                ...
                                <td class="text-font text-pedding" >{{$infoproject->PRO_TYPE}}</td>
                                <td class="text-font text-pedding" >{{$infoproject->PRO_TEAM_NAME}}</td>
                                <td class="text-font text-pedding" >{{$infoproject->PRO_NUMBER}}</td>
                                <td class="text-font text-pedding" >{{$infoproject->TARGET_ID}}</td>
                                <td class="text-font text-pedding" >{{$infoproject->KPI_ID}}</td>
                                <td class="text-font text-pedding" >{{$infoproject->PLAN_TYPE_ID}}</td>
                                <td class="text-font text-pedding" >{{$infoproject->PRO_NAME}}</td>
                                <td class="text-font text-pedding" ></td>
                                
                                <td class="text-font text-pedding" >{{DateThai($infoproject->BEGIN_DATE)}}</td>
                                <td class="text-font text-pedding" >{{DateThai($infoproject->PRO_END_DATE)}}</td>
                                <td class="text-font text-pedding" >{{$infoproject->BUDGET_PICE}}</td>
                                <td class="text-font text-pedding" >{{$infoproject->BUDGET_ID}}</td>
                                <td class="text-font text-pedding" ></td>
