    ...
    @endif
     ...
     <div class="row">
      ...
      <div class="modal-footer">
        ...
        <a href="{{ url('person_headdep/headdep_leave')}}"  class="btn btn-hero-sm btn-secondary" style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;">ปิดหน้าต่าง</a>
