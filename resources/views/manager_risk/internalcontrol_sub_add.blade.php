    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มรายการวิเคราะห์</h3>
            ...
            <br>
            <form  method="post" action="{{route('mperson.setupsetscore_save')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row push">
            <div class="col-lg-1" style="text-align: left">
                <label >ขั้นตอนการปฎิบัติ:</label>
            </div> 
            <div class="col-lg-11">
                <input name="TYPE_SCORE_NAME" id="TYPE_SCORE_NAME" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  >
            </div> 
        </div>
            
        <div class="row push">
            <div class="col-lg-1" style="text-align: left">
                <label > เพื่อลดความเสี่ยง: </label>
            </div> 
                <div class="col-lg-5">
                ...
                <div class="col-lg-5">
                    <table class="gwt-table table-striped table-vcenter" style="width: 100%;">
                        ...
                        <tbody class="tbody2">
                            <tr height="20"> 
                                <td>
                                    <input name="TYPE_SCORE[]" id="TYPE_SCORE[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
                                </td>
                                <td>
                                    <input name="TYPE_SCORE_SUB[]" id="TYPE_SCORE_SUB[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
                                </td>
       ...
       <br>
        ...
        <a href="{{ url('manager_risk/internalcontrol_sub')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" >ยกเลิก</a>
        </div>
