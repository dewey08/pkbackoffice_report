    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>รายงานความเสี่ยงย่อยที่เกิดอุบัติการณ์ความเสี่ยง</B></h3>   
                <div align="right ">
            ...
            <div class="block-content block-content-full">  
                <div class="row push">
                    ...
                    <div class="col-lg-2 ">
                    <select name="LEAVE_YEAR_ID" id="LEAVE_YEAR_ID" class="form-control input-sm" style="font-family:'Kanit',sans-serif;font-size:13px;font-weight:normal;">
                ...
                <div class="row push">
                    ...
                    <div class="col-lg-6 ">
                    <select name="INCIDENCE_CATEGORY_SUBSUB_NAME" id="INCIDENCE_CATEGORY_SUBSUB_NAME" class="form-control input-sm" style="font-family:'Kanit',sans-serif;font-size:13px;font-weight:normal;">
                                <option value="">--เลือก--</option>
                                    @foreach($category_subsubs as $category_subsub)
                                        <option value="{{ $category_subsub-> INCIDENCE_CATEGORY_SUBSUB_ID}}" >{{ $category_subsub-> INCIDENCE_CATEGORY_SUBSUB_NAME}}</option>
                                    @endforeach
                            </select> 
                    </div>
                    <div class="col-sm-1 "> 
            ...
            <div class="table-responsive"> 
               <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    <thead style="background-color: #FFEBCD;">
                        <tr height="40">
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="10%">รหัส:ชื่ออุบัติการณ์ความเสี่ยง</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="10%">อุบัติการณ์ความเสี่ยงย่อย</th> 
