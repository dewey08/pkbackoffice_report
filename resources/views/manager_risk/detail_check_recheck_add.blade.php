                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="RISK_RECHECK_HEAD" id="RISK_RECHECK_HEAD" class="form-control input-sm"
                                    style=" font-family: 'Kanit', sans-serif;" value="{{$infodetailrisk->RISKREP_DETAILRISK2}}">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <textarea name="RISK_RECHECK_DETAIL" id="RISK_RECHECK_DETAIL" rows="3" cols="50"
                                    ...
                                    style=" font-family: 'Kanit', sans-serif;">{{$infodetailrisk->RISKREP_DETAILRISK}}</textarea>
