    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h2 class="block-title" style="font-family: 'Kanit', sans-serif;">แก้ไขรายละเอียดการทบทวน</h2>   
                
                </div> 
            <div class="block-content block-content-full " align="left">


<form  method="post" action="{{ route('mrisk.risk_notify_repeat_sub_update') }}" enctype="multipart/form-data">
@csrf
...
<input type="hidden" name = "NOTIFY_REPEAT_ID"  id="NOTIFY_REPEAT_ID" class="form-control input-lg" value=" {{$notify_repeats->NOTIFY_REPEAT_ID}}" > 

<div class="row push">
    <div class="col-sm-2">
    <label style="font-family:'Kanit',sans-serif;font-size:13px;">รหัสความเสี่ยง :</label>
    </div> 
...
<div class="col-sm-1">
    ...
    <div class="row push">
        ...
        <div class="col-lg-2 ">
            <input value=" {{$notify_repeats->NOTIFY_REPEAT_NO}}"  name="NOTIFY_REPEAT_NO" id="NOTIFY_REPEAT_NO" class="form-control input-sm" style="font-family:'Kanit',sans-serif;font-size:13px;">
        </div>
        <div class="col-sm-2 ">        
            <label style="font-family:'Kanit',sans-serif;font-size:13px;">วันที่ทบทวน :</label>
        </div> 
        <div class="col-lg-2 ">
            <input value="{{ formate($notify_repeats->NOTIFY_REPEAT_DATE)}}" name="NOTIFY_REPEAT_DATE" id="NOTIFY_REPEAT_DATE" style="font-family:'Kanit',sans-serif;font-size:13px;" class="form-control input-sm datepicker" data-date-format="mm/dd/yyyy" readonly>
        ...
        <div class="block-content tab-content">
            <div class="tab-pane active" id="object1" role="tabpanel">                                      
             <table class="table gwt-table" >
                <thead>
                    ...
                    <tbody class="tbody1">
                        @foreach ($infer_repeats as $infer_repeat)
                        <tr>                                            
                            <td>
                                <input value="{{ $infer_repeat->INFER_REPEAT_DETAIL}}" name="INFER_REPEAT_DETAIL[]" id="INFER_REPEAT_DETAIL[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;font-size:13px;" >
                            </td>                        
            ...
            <div class="tab-pane" id="object2" role="tabpanel">
                <table class="table gwt-table" >
                    ...
                    <tbody class="tbody2">
                        @foreach ($infer_list_repeats as $infer_list_repeat)
                        <tr>                            
                            <td>
                                <input value="{{ $infer_list_repeat->LIST_INFER_DETAIL}}" name="LIST_INFER_DETAIL[]" id="LIST_INFER_DETAIL[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;font-size:13px;" >
                            </td>                        
                            <td style="text-align: center;"><a class="btn btn-danger fa fa-trash-alt remove" style="color:#FFFFFF;"></a></td>
                        </tr>
                        @endforeach
            ...
            <div class="tab-pane" id="object3" role="tabpanel">
                <table class="table gwt-table" >
                    ...
                    <tbody class="tbody3">
                        @foreach ($board_repeats as $board_repeat)  
                        <tr>                
                            <td>
                                <select name="BOARD_ID[]" id="BOARD_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;font-size:13px;" >
                                    <option value="">--กรุณาเลือกคณะกรรมการ--</option>   
                                    @foreach($infopers as $infoper)
                                    @if($board_repeat->BOARD_PER_ID == $infoper->ID)
                ...
                <table class="table gwt-table" >
                    <thead>
                        <tr>
                            ...
                            <td style="text-align: center;font-size:13px;">รายละเอียด4</td>
                    ...
                    <tbody class="tbody4">
                        <tr> 
                            @foreach ($board_out_repeats as $board_out_repeat)
                            <td>
                                <input value="{{ $board_out_repeat-> BOARD_OUT_FNAME}}" name="BOARD_OUT_FNAME[]" id="BOARD_OUT_FNAME[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;font-size:13px;" >
                            </td>
                            <td>
                                <input value="{{ $board_out_repeat-> BOARD_OUT_LNAME}}" name="BOARD_OUT_LNAME[]" id="BOARD_OUT_LNAME[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;font-size:13px;" >
                            </td>
            ...
            <div class="tab-pane" id="object5" role="tabpanel">           
                <table class="table gwt-table" >
                    ...
                    <tbody class="tbody5">
                        <tr> 
                            @foreach ($topic_repeats as $topic_repeat)
                            <td>
                                <input value="{{ $topic_repeat-> TOPIC_REPEAT_HEAD}}" name="TOPIC_REPEAT_HEAD[]" id="TOPIC_REPEAT_HEAD[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;font-size:13px;" >
                            </td>
                            <td>
                                <input value="{{ $topic_repeat-> TOPIC_REPEAT_DETAIL}}" name="TOPIC_REPEAT_DETAIL[]" id="TOPIC_REPEAT_DETAIL[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;font-size:13px;" >
                            </td>
                            <td style="text-align: center;"><a class="btn btn-danger fa fa-trash-alt remove" style="color:#FFFFFF;"></a></td>
                        </tr>
                        @endforeach  
            ...
            <div class="tab-pane" id="object6" role="tabpanel">
                ...
                <textarea rows="4" cols="50" id="NOTIFY_REPEAT_DETAIL" name="NOTIFY_REPEAT_DETAIL" class="form-control" style=" font-family: 'Kanit', sans-serif;background-color: #F0F8FF;">
                    {{ $notify_repeats-> NOTIFY_REPEAT_DETAIL}}
                </textarea>
