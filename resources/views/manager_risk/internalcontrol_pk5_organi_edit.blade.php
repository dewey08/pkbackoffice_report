...
<h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">
          ...
          แก้ไขรายงานการประเมินผลการควบคุมภายใน &nbsp;&nbsp; 
            </div>
          <div class="col-md-4" align="right">
         <!-- <small> แบบ ปค.5 องค์กร</small> -->
         <a href="{{ url('manager_risk/excel_risk_organi/'.$icontrol_organis->PK5_ORGANI_ID)}}" class="btn btn-success btn-lg" ><i class="fas fa-file-excel text-white" style="font-size:20px;"></i>&nbsp;&nbsp;Export Excel</a> 
...
<form  method="post" action="{{ route('mrisk.internalcontrol_pk5_organi_update') }}" enctype="multipart/form-data">
@csrf
            ...
            <input type="hidden" id="PK5_ORGANI_ID" name="PK5_ORGANI_ID" value="{{$icontrol_organis->PK5_ORGANI_ID}}">    
<div class="row push">
<div class="col-sm-1">
<label for="BUDGET_YEAR" style="font-family:'Kanit',sans-serif;font-size:14px;font-weight:normal;">ระยะเวลา :</label>
...
<div class="col-lg-2 "> 
<input  name = "DATE_BIGIN"  id="DATE_BIGIN"  class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  value="{{ formate($icontrol_organis->PK5_ORGANI_START_DATE) }}"  readonly>
...
<div class="col-lg-2"> 
<input  name = "DATE_END"  id="DATE_END"  class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  value="{{ formate($icontrol_organis->PK5_ORGANI_END_DATE) }}" readonly>
</div> 
<div class="col-sm-0.5">
<label style="font-family:'Kanit',sans-serif;font-size:13px;">วันที่บันทึก :</label>
</div> 
<div class="col-lg-2 ">
<input type="text" name="PK5_ORGANI_DATE" id="PK5_ORGANI_DATE" class="form-control input-sm datepicker" data-date-format="mm/dd/yyyy" value="{{ formate($icontrol_organis->PK5_ORGANI_DATE) }}" readonly>
</div> 
        ...
        <table class="gwt-table table-vcenter" style="width: 100%;">
                        ...
                        <?php $number = 0; ?>
                            ...
                            <tr style="background-color: #EDF9F2;"> 
                                ...
                                <tr style="background-color: #EDF9F2;"> 
                                        <input type="hidden" name="PK5_ORGANI_SUB_ID[]" id="PK5_ORGANI_SUB_ID[]" value="{{$id}}">
                                        <td  style="text-align: left;font-size: 13px;vertical-align: top;">        
                                        &nbsp;&nbsp; {{$icontrol_organisub->PK5_ORGANI_SUB_CONTROL }}
                                        <input type="hidden" name="PK5_ORGANI_SUB_CONTROL[]" id="PK5_ORGANI_SUB_CONTROL[]" value="{{$icontrol_organisub->PK5_ORGANI_SUB_CONTROL }}">
                                        </td>

                                        <td  style="text-align: left;font-size: 13px;vertical-align: top;">  
                                        &nbsp;&nbsp;{{$icontrol_organisub->PK5_ORGANI_SUB_HAVERISK }}
                                        <input type="hidden" name="PK5_ORGANI_SUB_HAVERISK[]" id="PK5_ORGANI_SUB_HAVERISK[]" value="{{$icontrol_organisub->PK5_ORGANI_SUB_HAVERISK}}">
                                        </td>
                                 
                                        <td>
                                            <textarea name="PK5_ORGANI_SUB_UPDATECONTROL[]" id="PK5_ORGANI_SUB_UPDATECONTROL[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;font-size: 13px;" rows="5">{{$icontrol_organisub->PK5_ORGANI_SUB_UPDATECONTROL}}</textarea>
                                        </td>
                                        

                                        <td>
                                            <textarea name="PK5_ORGANI_SUB_USER[]" id="PK5_ORGANI_SUB_USER[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;font-size: 13px;" rows="5">{{$icontrol_organisub->PK5_ORGANI_SUB_USER}}</textarea>
                                        </td>
                                </tr>
                            @endforeach   
