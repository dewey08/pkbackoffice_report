    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B> รายงานกลุ่ม/หน่วยงานที่แก้ไขอุบัติการณ์ความเสี่ยง</B></h3>   
                ...
                <div class="row push">
                    ...
                    <button class="btn btn-info text-white" type="submit" style="font-family:'Kanit',sans-serif;font-size:14px;font-weight:normal;"><i class="fa fa-search fa-sm text-white" style="font-size:17px "></i>&nbsp;&nbsp;ค้นหา </button> 
                        ...
                        <div class="row push">
                           ...
                           <div class="col-lg-8 " >
                           <label style="font-family:'Kanit',sans-serif;font-size:14px;">c || d โดย c = จำนวนรายงานอุบัติการณ์ความเสี่ยงที่กลุ่ม/หน่วยงานหลักต้องแก้ไข  d = จำนวนรายงานอุบัติการณ์ที่กลุ่ม/หน่วยงานหลักทำการแก้ไขเสร็จแล้ว</label>
                         </div> 
                           <div class="col-sm-2" >
               ...
               <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    <thead style="background-color: #FFEBCD;">
                        <tr height="40">
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="10%">กลุ่ม/หน่วยงานที่มีการแก้ไขความเสี่ยง</th> 
