...
<br>
<center>   
    <form  method="post" action="{{ route('mguesthouse.guesthouseutilitybills_savewater') }}" enctype="multipart/form-data">
        @csrf   
            ...
            <div class="block-header block-header-default">
                ...
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input type="text" id="GUEST_WATER_PICEUNTI" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;  font-size: 13px;" name="GUEST_WATER_PICEUNTI" OnKeyPress="return chkNumber(this)">
                        </div>
                        <div class="col-md-1"  style="font-size: 13px;";>
                            บาท
                        </div>
             ...
             <div class="table-responsive"> 
               ...
               {{$infoinfomation->INFMATION_NAME}}
                <table class="gwt-table table-striped table-vcenter js-dataTable-simple" width="100%">
                    <thead style="background-color: #cdf3ff;">
                        <tr height="40">
                          
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;" >รายละเอียด</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;" width="20%">เลขมอนิเตอร์เดือนที่แล้ว</th>
                ...
                <input type="hidden" id="LOCATION_ID[]" name="LOCATION_ID[]" value="{{$infoinfomation->LOCATION_ID}}">
                ...
                <tr height="20">
                    ...
                    <td class="text-font text-pedding" style="border-color:#F0FFFF;text-align: center;font-size: 13px;border: 1px solid black;">    
                        <input type="text" id="GUEST_WATER_METER_NUM[]" name="GUEST_WATER_METER_NUM[]" OnKeyPress="return chkNumber(this)">
                    </td>                                                                           
                    <td class="text-font text-pedding" style="border-color:#F0FFFF;text-align: center;font-size: 13px;border: 1px solid black;">
                    ...
                    ?>
                        ...
                        <tr height="20">
                            ...
                            <?php $number= 0; ?>
                                ...
                                <input type="hidden" id="LOCATION_ID[]" name="LOCATION_ID[]" value="{{$infoinfomation->LOCATION_ID}}">
                                <input type="hidden" id="LOCATION_LEVEL_ID[]" name="LOCATION_LEVEL_ID[]" value="{{$infoguesthouse_level->LOCATION_LEVEL_ID}}">
                                <input type="hidden" id="LEVEL_ROOM_ID[]" name="LEVEL_ROOM_ID[]" value="{{$infoguesthouse_room->LEVEL_ROOM_ID}}">
                                <tr height="20">
