...
<center>    
     <div class="block" style="width: 95%;">
                        ...
                        <div class="block-header block-header-default">
                            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>รายงานการขอใช้รถทั่วไป แบบ ๖</B></h3>
                          
                        </div>
                        <div class="block-content block-content-full">


            <form method="post" action="{{route('mcar.reportcarsixsearch')}}">
                @csrf
                <div class="row">
                            ...
                            <select name="SEND_STATUS" id="SEND_STATUS" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" required>
                                <option value="">--กรุณาเลือก--</option>
                                    @foreach ($infocar_sendstatuss as $infocar_sendstatus)
                                        ...
                                        <option value="{{ $infocar_sendstatus->ARTICLE_ID  }}" selected>{{ $infocar_sendstatus->CAR_REG}}</option>
                                         @else
                                         <option value="{{ $infocar_sendstatus->ARTICLE_ID  }}">{{ $infocar_sendstatus->CAR_REG}}</option>
                                        @endif
                                    @endforeach
                            </select>
                        </span>
