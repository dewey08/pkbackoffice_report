        ...
        <div class="block" style="width: 95%;">
            ...
            <div class="block block-rounded block-bordered">
                <div class="block-header block-header-default">
                    <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>รายงานประเภทรถประจำตำแหน่ง</B></h3>
                    <a href="{{ url('manager_car/excelcarposition')}}"  class="btn btn-hero-sm btn-hero-success"  ><li class="fa fa-file-excel mr-2"></li>Export Excel</a>&nbsp;&nbsp;&nbsp;&nbsp;                   
                </div>
