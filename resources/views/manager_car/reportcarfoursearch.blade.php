...
<center>    
     <div class="block" style="width: 95%;">
                        ...
                        <div class="block-header block-header-default">
                            <div align="left">
                                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>รายงานการขอใช้รถทั่วไป แบบ๔</B>&nbsp;&nbsp;&nbsp;<label style="font-family: 'Kanit', sans-serif;font-weight:normal;color:blue">รถหมายเลขทะเบียน &nbsp;{{$regcars->CAR_REG}}</label></h3>
                            </div>
                            ...
                            <table class="table-bordered table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                                ...
                                <?php $number++; ?>
                                    <tr height="20">
                                        ...
                                        <td class="text-font" style="border-color:#F0FFFF;text-align: center;border: 1px solid black;">{{DateThai($infocar->BACK_DATE)}} &nbsp;/&nbsp; {{ formatetime($infocar->BACK_TIME) }}&nbsp; น.</td>                                        
                                        @else
