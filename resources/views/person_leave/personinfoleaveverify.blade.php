...
?>
                ...
                <div class="block-header block-header-default ">
                            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ตรวจสอบการลา</B></h3>
                </div>
    ...
    <div class="form-group">
      ...
      <textarea   name = "COMMENT"  id="COMMENT" class="form-control input-lg"></textarea>--->
        ...
        <a href="{{ url('person_leave/personleaveinfover/'.$user_id)  }}" class="btn btn-warning btn-lg" >กลับหน้าตรวจสอบ</a>
