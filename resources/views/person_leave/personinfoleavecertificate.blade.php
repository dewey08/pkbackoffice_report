...
<form  method="post" id="form_add" action="{{ route('leave.leavecertificate_save') }}"  enctype="multipart/form-data" >      
    @csrf
...
<div class="modal-footer">
        ...
        <a href="{{ url('person_leave/personleaveinfo/'.$detailleave->LEAVE_PERSON_ID)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close mr-2"></i>ยกเลิก</a>
        </div>
