...
<!--<body onload="checkall();">-->
                ...
                <form  method="post" action="{{ route('leave.save') }}"  enctype="multipart/form-data"  class="needs-validation" novalidate>
    ...
    <div class="block-content"> 
                 @if($leavetype == 'sick')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาป่วย :</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3>
                          
                @elseif($leavetype == 'spawn')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาคลอดบุตร</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3> 
                @elseif($leavetype == 'work')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลากิจ</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3> 
                @elseif($leavetype == 'rest')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาพักผ่อน</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3> 
                @elseif($leavetype == 'religion')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาอุปสมบท/ประกอบพิธีฮัจญ์ </B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3> 
                @elseif($leavetype == 'helpspawn')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาช่วยภริยาคลอด </B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3> 
                @elseif($leavetype == 'military')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาเกณฑ์ทหาร</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3>
                @elseif($leavetype == 'train')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาศึกษา ฝึกอบรม</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3>
                @elseif($leavetype == 'abroad')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาทำงานต่างประเทศ</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3>
                @elseif($leavetype == 'mate')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาติดตามคู่สมรส</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3>
                @elseif($leavetype == 'restore')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาฟื้นฟูอาชีพ</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3>
                @elseif($leavetype == 'resign')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>บันทึกข้อมูลลาออก</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3>
                @elseif($leavetype == 'sicklow')
                <h3 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><B>ลาป่วยตามกฎหมายฯ :</B><label style="color: #778899;">&nbsp;&nbsp;&nbsp;&nbsp;วันที่บันทึก {{ DateThai(date("Y-m-d"))}}</label></h3>
                @endif
    ...
    <div class="row push">
                    ...
                    <div class="col-lg-4">
                        ...
                        @if($leavetype == 'religion')
                            <div class="form-group">
                                    ...
                                    <input name ="ODEIN_TEMPLE" id="ODEIN_TEMPLE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                    <label>ที่ตั้งวัด <div style="color: red;" id="odentempleadd"></div> </label>
                                    <input name ="ODEIN_TEMPLE_ADD" id="ODEIN_TEMPLE_ADD" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="ODEIN_DATE" id="ODEIN_DATE" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" readonly>
                            </div>

                        @elseif($leavetype == 'helpspawn')
                           <div class="form-group">
                                    <label>คำขึ้นต้น <div style="color: red;" id="leavewordbegin"></div> </label>
                                    <input name ="LEAVE_WORD_BEGIN" id="LEAVE_WORD_BEGIN" class="form-control input-lg " style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                    <label>ชื่อ สุกลภริยา <div style="color: red;" id="leavemarryname"></div> </label>                              
                                    <input name="LEAVE_MARRY_NAME" id="LEAVE_MARRY_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                <label>วันที่คลอด <div style="color: red;" id="leavedatespawn"></div> </label>
                                <input name="LEAVE_DATE_SPAWN" id="LEAVE_DATE_SPAWN" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" readonly>
                            </div>
                        @elseif($leavetype == 'military')
                        <div class="form-group">
                                    <label>รับหมายเรียกจาก <div style="color: red;" id="armyby"></div></label>
                                    <input name ="ARMY_BY" id="ARMY_BY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                    <label>เลขที่หมายเรียก<div style="color: red;" id="armynum"></div></label>                              
                                    <input name="ARMY_NUM" id="ARMY_NUM" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                <label>ระบุวันที่<div style="color: red;" id="armydate"></div></label>
                                <input name="ARMY_DATE" id="ARMY_DATE" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;"  readonly>
                            </div>
                            <div class="form-group">
                                    <label>ให้เข้ารับการ<div style="color: red;" id="armyvisit"></div></label>                              
                                    <input name="ARMY_VISIT" id="ARMY_VISIT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                        @elseif($leavetype == 'mate')  
                           <div class="form-group">
                                    <label>ได้รับเงินเดือน  <div style="color: red;" id="fwmarrysalary"></div></label>
                                    <input name ="FW_MARRY_SALARY" id="FW_MARRY_SALARY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                    <label>ชื่อคู่สมรส <div style="color: red;" id="fwmarry"></div></label>                              
                                    <input name="FW_MARRY" id="FW_MARRY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>  
                            <div class="form-group">
                                    <label>ตำแหน่งคู่สมรส <div style="color: red;" id="fwmarryposition"></div></label>                              
                                    <input name="FW_MARRY_POSITION" id="FW_MARRY_POSITION" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div> 
                            <div class="form-group">
                                    <label>ระดับ <div style="color: red;" id="fwmarrylevel"></div></label>                              
                                    <input name="FW_MARRY_LEVEL" id="FW_MARRY_LEVEL" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            
                        @elseif($leavetype == 'train')
                        <div class="form-group">
                                    <label>ศึกษาวิชา<div style="color: red;" id="edusubject"></div> </label>                              
                                    <input name="EDU_SUBJECT" id="EDU_SUBJECT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div> 
                            <div class="form-group">
                                    <label>ชั้นปริญญา<div style="color: red;" id="edubranch"></div> </label>                              
                                    <input name="EDU_BRANCH" id="EDU_BRANCH" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div> 
                            <div class="form-group">
                                    <label>สถานศึกษา<div style="color: red;" id="eduacademy"></div> </label>                              
                                    <input name="EDU_ACADEMY" id="EDU_ACADEMY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                    <label>ประเทศ</label>                              
                            ...
                            <div class="form-group">
                                    ...
                                    <input name="EDU_TON" id="EDU_TON" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"  onkeyup="checkall();">
                            </div>  
                        ...
                        @elseif($leavetype == 'resign')
                         <div class="form-group">
                                    ...
                                    <input name ="EXIT_POSITION_TYPE" id="EXIT_POSITION_TYPE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{ $inforpersonuser -> HR_PERSON_TYPE_NAME }}" readonly>
                            </div>
                            <div class="form-group">
                                <label>วันที่ลาออก<div style="color: red;" id="exitindate"></div></label>
                                <input name="EXIT_IN_DATE" id="EXIT_IN_DATE" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" readonly>
                            </div>
                            <div class="form-group">
                                    <label>สัญญาจ้างเลขที่<div style="color: red;" id="exitpersonvcode"></div></label>
                                    <input name ="EXIT_PERSON_VCODE" id="EXIT_PERSON_VCODE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"  onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                <label>ลงวันที่<div style="color: red;" id="exitpersonvcodedate"></div></label>
                                <input name="EXIT_PERSON_VCODE_DATE" id="EXIT_PERSON_VCODE_DATE" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" readonly>
                            </div>
                        ...
                        @else
                         <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <input name="LEAVE_BECAUSE" id="LEAVE_BECAUSE" class="form-control input-lg"  style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                    ...
                    <div class="form-group">
                                    ...
                                    <input name="ARMY_VISIT_ADD" id="ARMY_VISIT_ADD" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                    </div>
                    @elseif($leavetype == 'religion')
                    <div class="form-group">
                                    <label>จำพรรษา ณ วัด<div style="color: red;" id="odentemplelive"></div> </label>                              
                                    <input name="ODEN_TEMPLE_LIVE" id="ODEN_TEMPLE_LIVE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                    </div>
                    <div class="form-group">
                                    <label>ตั้งอยู่<div style="color: red;" id="odentempleliveadd"></div> </label>                              
                                    <input name="ODEN_TEMPLE_LIVE_ADD" id="ODEN_TEMPLE_LIVE_ADD" class="form-control input-lg " style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                                    ...
                                    <input name="FW_MARRY_UNDER" id="FW_MARRY_UNDER" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"onkeyup="checkall();">
                            </div>  
                    ...
                    @elseif($leavetype == 'resign')
                            ...
                            <div class="form-group">
                                    ...
                                    <input name ="EXIT_SALARY" id="EXIT_SALARY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"onkeyup="checkall();">
                            </div>
                    @elseif($leavetype == 'train')     
                           <div class="form-group">
                                    <label>หลักสูตร<div style="color: red;" id="edutcourse"></div> </label>
                                    <input name ="EDU_T_COURSE" id="EDU_T_COURSE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                    <label>สถานที่<div style="color: red;" id="edutlocation"></div> </label>
                                    <input name ="EDU_T_LOCATION" id="EDU_T_LOCATION" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                            <div class="form-group">
                                    <label>ประเทศ</label>
                    ...
                    @if($leavetype != 'resign')
                                              @if($leavetype == 'train' || $leavetype == 'spawn')
                                                <div class="form-group">
                                                ...
                                                <input name="date_bigen" id="date_bigen" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy" onchange="calldate();" style=" font-family: 'Kanit', sans-serif;" readonly>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <input name="date_end" id="date_end" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy" onchange="calldate();" style=" font-family: 'Kanit', sans-serif;" readonly>
                                                </div>
                                                @else

                                                <div class="form-group">
                                                <label>ลาตั้งแต่วันที่ <div style="color: #DC143C;" class="checkdatebegin"><input type="hidden" name ="checkbigin_date" id="checkbigin_date" value="false"></div></label>
                                                <input name="date_bigen" id="date_bigen" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy" onchange="checkdatebegin();calldate();" style=" font-family: 'Kanit', sans-serif;" readonly>
                                                </div>
                                                <div class="form-group">
                                                <label>ถึงวันที่<div style="color: #DC143C;" class="checkdateend"><input type="hidden" name ="checkend_date" id="checkend_date" value="false"></div></label>
                                                <input name="date_end" id="date_end" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy" onchange="checkdateend();calldate();" style=" font-family: 'Kanit', sans-serif;" readonly>
                                                </div>
                                                ...
                                                <input name="DATE_OFF" id="DATE_OFF" class="form-control input-lg"  onkeyup="checkdateend();calldate();" style=" font-family: 'Kanit', sans-serif;" >
                                                </div>
            ...
            <div class="form-group"> 
                <label>เบอร์โทรติดต่อ<div style="color: red;" id="leavecontact_phone"></div> </label>  
                    <input name="LEAVE_CONTACT_PHONE" id="LEAVE_CONTACT_PHONE" class="form-control input-lg" value="{{$inforpersonuser -> HR_PHONE }}" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                    </div>
                    @endif
            ...
            <div class="form-group">
                                ...
                                <input name="EXIT_DATE_BEGIN" id="EXIT_DATE_BEGIN" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" readonly>
                            </div>
                            <div class="form-group">
                                <label>สิ้นสุดวันที่<div style="color: red;" id="exitdatefinish"></div></label>
                                <input name="EXIT_DATE_FINISH" id="EXIT_DATE_FINISH" class="form-control input-lg datepicker" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" readonly>
                            </div>
                            <div class="form-group">
                                <label>ลาออกเพราะ<div style="color: red;" id="exitbecause"></div></label>
                                <input name="EXIT_BECAUSE" id="EXIT_BECAUSE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="checkall();">
                            </div>
                ...
                <div class="form-group">
                    ...
                    <textarea  name ="LEAVE_CONTACT" id="LEAVE_CONTACT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif; height: 120px;" onkeyup="checkall();">บ้านเลขที่ {{ $inforpersonuser -> HR_HOME_NUMBER }}  หมู่ที่ {{ $inforpersonuser -> HR_VILLAGE_NO }} ถนน {{  $inforpersonuser -> HR_ROAD_NAME }} ซอย {{ $inforpersonuser -> HR_SOI_NAME }} ตำบล  {{ $inforpersonuser -> TUMBON_NAME }} อำเภอ {{ $inforpersonuser -> AMPHUR_NAME }} จังหวัด {{ $inforpersonuser -> PROVINCE_NAME }}  รหัสไปรษณีย์  {{ $inforpersonuser -> HR_ZIPCODE }}</textarea>
            </div>
            ...
            <div class="form-group">
                    ...
                    <select name="LEADER_DEP_PERSON_ID" id="LEADER_DEP_PERSON_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;"  onchange="checkall();">
                        ...
                        @foreach ($leader_alls as $leader_all)   
                                @if( $leader_all ->LEADER_HR_ID  == $checkleader)                                                  
            ...
            <div class="form-group">
                   ...
                   <input name="LEAVE_COMMENT_BY" id="LEAVE_COMMENT_BY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;">
            </div>
