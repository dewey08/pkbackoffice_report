...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลหน่วยงาน</h2>    

    
        <form  method="post" action="{{ route('admin.saveorg') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
    ...
    <div class="col-lg-2">
      ...
      <div class="col-lg-4">
      <input  name = "RECORD_ORG_NAME"  id="RECORD_ORG_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_record_org_name();">
      <div style="color: red; font-size: 16px;" id="record_org_name"></div>
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-save"></i>  บันทึกข้อมูล</button>
         <a href="{{ url('admin_dev/setupinfoorg')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close"></i>   ยกเลิก</a> 
         </div>    
