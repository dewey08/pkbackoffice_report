...
?>
                ...
                <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;"><i class="fas fa-plus"></i> เพิ่มข้อมูลกลุ่มบุคลากร</h2>    

    
        <form  method="post" action="{{ route('admin.savepersontype') }}" enctype="multipart/form-data">
        @csrf
        <div class="row push">
      ...
      <div class="col-lg-3">
      <input  name = "HR_PERSON_TYPE_NAME"  id="HR_PERSON_TYPE_NAME" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_hr_person_type_name();">
    ...
    <div class="col-lg-1">
      ...
      <div class="col-lg-4">
      <input  name = "HR_LEAVE04_CMD"  id="HR_LEAVE04_CMD" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_hr_leave04_cmd();">
    ...
    <div class="col-lg-1">
      ...
      <div class="col-lg-1">
      <input  name = "HR_LEAVE04_DAY"  id="HR_LEAVE04_DAY" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" onkeyup="check_hr_leave04_day();" >
    ...
    <div class="col-lg-1">
      <label >วัน</label>
        ...
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-save"></i>  บันทึกข้อมูล</button>
         <a href="{{ url('admin_person/setupinfopersongroup')  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close"></i>  ยกเลิก</a> 
         </div>    
