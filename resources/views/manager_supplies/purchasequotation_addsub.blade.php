...
<div class="block-header block-header-default" >
    ...
    <button  type="button" onclick="selectvendor({{$requestid}})"  class="btn btn-info btn-lg" style="font-family: 'Kanit', sans-serif; font-size: 10px;font-size: 1.0rem;font-weight:normal;">เพิ่มข้อมูลบริษัทจากจากใบคำขอ</button> 
    @endif
</div>
<form  method="post" id="form_add" action="{{ route('msupplies.savepurchasequotationsub') }}"  enctype="multipart/form-data"  class="needs-validation" novalidate>      
    @csrf
...
<div class="modal-footer">
        ...
        <a href="{{ url('manager_supplies/purchasequotation_add/'.$IDCON)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close mr-2"></i>ยกเลิก</a>
        </div>
