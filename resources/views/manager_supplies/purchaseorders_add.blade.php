    ...
    <div class="row">
        <div class="col-md-8">
          ...
          @endif
            ...
            <div class="col-lg-1">  
                <input type="text" name="datecal" id="datecal" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" onkeyup="calldatesend();" >
            </div> 
            <div class="col-lg-1">  
                วัน
            </div> 
            <div class="col-lg-2 datesend">  
...
var datecal= document.getElementById("datecal").value; 
  ...
  var _token=$('input[name="_token"]').val();
       $.ajax({
               url:"{{route('msupplies.calldatesend')}}",
               method:"GET",
               data:{datecal:datecal,_token:_token},
               success:function(result){
                $('.datesend').html(result);
