                    ...
                    <div class="block block-rounded block-bordered">
                        ...
                        <div class="block-content tab-content">
                            ...
                            <div class="tab-pane active" id="object1" role="tabpanel">
                                ...
                                <a href="{{ url('manager_supplies/suppliesinfo/suppliesinfoinasset_add/'.$infosupplie->ID)  }}"
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" style="width:10px">
                                                            <a class="dropdown-item"
                                                                href="{{ url('manager_supplies/suppliesinfo/suppliesinfoinasset_edit/'.$infosupplie->ID.'/'.$infosupplieinasset->ARTICLE_ID)  }}"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ url('manager_supplies/suppliesinfo/destroysuppliesinfoinasset/'.$infosupplie->ID.'/'.$infosupplieinasset->ARTICLE_ID)  }}"
                                                                style="font-family: 'Kanit', sans-serif; font-size: 13px;font-weight:normal;"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <body>
                                                    ...
                                                    <form  method="post" action="{{ route('msupplies.detailfsn_save') }}" >
                                                        @csrf
