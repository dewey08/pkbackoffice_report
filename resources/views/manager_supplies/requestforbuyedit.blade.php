...
<h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>แก้ไขการขอซื้อขอจ้างพัสดุ</B></h3>

</div>                
<div class="block-content block-content-full" style="text-align: left;"  >
       
           <form  method="post" action="{{ route('msupplies.requestforbuyupdate') }}" enctype="multipart/form-data"> 
        @csrf
...
<div class="col-lg-2">
    <input name="DATE_WANT" id="DATE_WANT" class="form-control input-sm datepicker {{$errors->has('DATE_WANT') ? 'is-invalid' : '' }}" data-date-format="mm/dd/yyyy"  style=" font-family: 'Kanit', sans-serif;" value="{{formate($inforequest->DATE_WANT)}}" readonly>
</div>
<div class="col-sm-2 text-right">
        <label>เพื่อจัดซื้อ/ซ่อมแซม :</label>
    </div>
<div class="col-lg-6">
            <select name="REQUEST_FOR_ID" id="REQUEST_FOR_ID" class="form-control input-sm js-example-basic-single {{$errors->has('REQUEST_FOR_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
...
<div class="col-sm-2">
    ...
    <div class="col-lg-2">
                 ...
                 <select name="YEAR_ID" id="YEAR_ID" class="form-control input-lg {{$errors->has('YEAR_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;">
    ...
    <div class="col-lg-2">
        <input name="DEP_SUB_SUB_PHONE" id="DEP_SUB_SUB_PHONE" class="form-control input-sm {{$errors->has('DEP_SUB_SUB_PHONE') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{$inforequest->DEP_SUB_SUB_PHONE}}">
    </div>
</div>
<div class="row push">
<div class="col-sm-2">
    ...
    <div class="col-sm-2">
        ...
        <div class="col-lg-4">
            <select name="AGREE_HR_ID" id="AGREE_HR_ID" class="form-control input-sm js-example-basic-single {{$errors->has('AGREE_HR_ID') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" >
...
<div class="col-sm-10">
<input name="REQUEST_BUY_COMMENT" id="REQUEST_BUY_COMMENT" class="form-control input-sm {{$errors->has('REQUEST_BUY_COMMENT') ? 'is-invalid' : '' }}" style=" font-family: 'Kanit', sans-serif;" value="{{$inforequest->REQUEST_BUY_COMMENT}}" maxlength="70">
</div>
</div>
...
<div class="col-sm-7"></div> <div class="col-sm-1"><label>รวมมูลค่า </div><div class="col-sm-3 text-left"><input class="form-control input-sm " style="text-align: center;background-color:#E0FFFF ;font-size: 13px;" type="text" name="total" id="total" readonly></div><div class="col-sm-1"><label>  บาท</label></div>
 ...
 <table class="gwt-table table-striped table-vcenter" style="width: 100%;">
    ...
    <tr height="40">
            ...
            <td style="text-align: center;" width="7%">เลือก</td>
            <td style="text-align: center;" width="10%">จำนวน</td>
            <td style="text-align: center;" width="10%">หน่วย</td>
            <td style="text-align: center;" width="19%">ราคาต่อหน่วย</td>
            <td style="text-align: center;" width="19%">จำนวนเงิน</td>
            <td style="text-align: center;" width="12%">
                <a  class="btn btn-hero-sm btn-hero-success addRow" style="color:#FFFFFF;"><i class="fas fa-plus-square"></i></a>
    ...
    <tr height="20">
            ...
            <td style="text-align: left;" class="text-pedding">
                                <button type="button" class="btn btn-hero-sm btn-hero-info" data-toggle="modal" data-target=".addsup" style="font-family: \'Kanit\', sans-serif; font-size: 10px;font-weight:normal;"   onclick="supselect(0);">เลือก</button>
                                </td>
            <td>
...
<div class="modal-footer">
    <div align="right">
        <button type="submit"  class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-save"></i> &nbsp;บันทึกข้อมูล</button>
            <a href="{{ url('manager_supplies/requestforbuy') }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" ><i class="fas fa-window-close"></i> &nbsp;ยกเลิก</a>
    </div>
</div>
</form>
...
<div class="modal fade addsup" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modeladdsup">
        ...
        <br>
            ...
            <div class="modal-footer">
                <div align="right">
                        <button type="button" class="btn btn-hero-sm btn-hero-danger" data-dismiss="modal" ><i class="fas fa-sign-out-alt mr-2"></i>ปิดหน้าต่าง</button>
                </div>
            </div>
        </body>
    </div>
    ...
    var number = count+1;
        var tr =   '<tr>'+
                '<td style="text-align: center;">'
                    +number+
                '</td>'+
                '<td class="infoselectsupreq'+number+'" >'+
                '</td>'+
                '<td style="text-align: left;" class="text-pedding">'+
                '<button type="button" class="btn btn-hero-sm btn-hero-info" data-toggle="modal" data-target=".addsup" style="font-family: \'Kanit\', sans-serif; font-size: 10px;font-weight:normal;"   onclick="supselect('+number+');">เลือก</button>'+
                '</td>'+
                '<td>'+
                '<input name="SUPPLIES_REQUEST_SUB_AMOUNT[]" id="SUPPLIES_REQUEST_SUB_AMOUNT'+number+'" class="form-control input-sm" style=" font-family: \'Kanit\', sans-serif;" onkeyup="checksummoney('+number+');" OnKeyPress="return chkNumber(this)">'+
                '</td>'+
                '<td style="text-align: left;" class="text-pedding infounitname'+number+'" >'+                
                '</td>'+
                '<td>'+
                '<input name="SUPPLIES_REQUEST_SUB_PRICE[]" id="SUPPLIES_REQUEST_SUB_PRICE'+number+'" class="form-control input-sm" style=" font-family: \'Kanit\', sans-serif;" onkeyup="checksummoney('+number+');" OnKeyPress="return chkNumber(this)">'+
                '</td>'+
                '<td>'+
