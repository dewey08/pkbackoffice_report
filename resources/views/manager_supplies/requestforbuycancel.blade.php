...
<h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ยกเลิกการขอซื้อขอจ้างพัสดุ</B></h3>

</div>                
<div class="block-content block-content-full"  style="text-align: left;">

           <form  method="post" action="{{ route('msupplies.cancelrequestforbuyupdate') }}" enctype="multipart/form-data">
        @csrf
    ...
    <div align="right">จำนวนเงินรวม {{number_format($inforequest -> BUDGET_SUM,2)}}  บาท</div>
       <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
        ...
        <div class="modal-footer">
            <div align="right">
              <button type="submit"  class="btn btn-hero-sm btn-hero-danger" ><i class="fas fa-check-circle"></i>&nbsp;ยืนยันการยกเลิกคำร้อง</button> 
                    <a href="{{ url('manager_supplies/requestforbuy') }}" class="btn-hero-sm btn-hero-secondary"><i class="fas fa-window-close"></i> &nbsp;ปิดหน้าต่าง</a>
            </div>
        </div>
    </form>
