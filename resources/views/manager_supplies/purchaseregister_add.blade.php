...
use App\Http\Controllers\FormpdfController;
    $checkpur = FormpdfController::checkpur($id_user);
    $checkpurmanage = FormpdfController::checkpurmanage($id_user);
?>
<?php
            ...
            <div align="left">
                ...
                <div class="block-content"> 
                    ...
                    @if ($checkpur != 0 )
                        ...
                        <form  method="post" action="{{ route('msupplies.savepurchaseregisteronly') }}" enctype="multipart/form-data">
                            @csrf
                            <h2 class="content-heading pt-0" style="font-family: 'Kanit', sans-serif;">
                                <div class="row">
                                    <div class="col-sm-2"> ออกทะเบียนคุม </div>
                                    <div class="col-sm-2">
                                        <input name="CON_NUM" id="CON_NUM" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$maxnumberuse}}" required>
                                    </div>                    
                                    <div class="col-sm-1"> <label>ปีงบประมาณ :</label> </div> 
                                    <div class="col-lg-1">  
