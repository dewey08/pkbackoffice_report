    ...
    <input type="hidden" name="typedetail" id="typedetail" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$typedetail}}">
       ...
       <div class="col-lg-4">
        ...
        <div class="col-lg-7 number_parcel">
            ...
            <input name="SUP_FSN_NUM" id="SUP_FSN_NUM" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infosupplie->SUP_FSN_NUM}}" readonly>
            @else
       ...
       <div class="row push">
        ...
        @if($checkcodeinstore > 0 )
                {{$infosupplie->SUP_TYPE_NAME}}
                <input type="hidden"  name="SUP_TYPE_ID" id="SUP_TYPE_ID" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{$infosupplie->SUP_TYPE_ID}}">
        @else
