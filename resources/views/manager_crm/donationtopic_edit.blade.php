...
<div class="block mt-5" style="width: 95%;" >
    <div class="block block-rounded block-bordered">            
            ...
            <div class="block-header block-header-default">
                <h3 class="block-title text-left" style="font-family: 'Kanit', sans-serif;"><B>แก้ไขหัวข้อการรับบริจาค</B></h3>
                &nbsp;&nbsp;
...
<a href="{{ url('manager_crm/donationtopic')  }}" class="btn btn-hero-sm btn-hero-danger foo14" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" ><i class="fas fa-window-close mr-2"></i>ยกเลิก</a>
</div>
