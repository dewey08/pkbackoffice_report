...
<div class="block mt-5" style="width: 95%;" >
    <div class="block block-rounded block-bordered"> 
        <div class="block-header block-header-default">
            <h3 class="block-title text-left" style="font-family: 'Kanit', sans-serif;"><B>เพิ่มรายชื่อกองทุน</B></h3>
            &nbsp;&nbsp;
...
<form  method="post" action="{{ route('mcrm.donation_fund_save') }}" enctype="multipart/form-data">
@csrf
...
<div class="row push">
    ...
    <div class="col-lg-11 ">              
    <input  name="DONATE_FUND_NAME" id="DONATE_FUND_NAME" class="form-control input-lg fo13" required>
    </div> 
