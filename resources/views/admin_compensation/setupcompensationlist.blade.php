                      ...
                      <table class="gwt-table table-striped table-vcenter" width="100%">
                        <thead style="background-color: #FFEBCD;">                        
                          <tr  height="40">
                              ...
                              <th  class="text-font" style="border-color:#F0FFFF;text-align: center;">ประเภทบุคคล</th>
                              <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="12%">คำสั่ง</th>
                          </tr>                   
                        </thead>
                        <tbody id="myTable">  
                          @foreach ($compensationlists as $compensationlist) 
                            <tr  height="20">
                                <td class="text-font" align="center" >{{ $compensationlist-> HR_PERSON_TYPE_ID }}</td> 
                                <td class="text-font text-pedding" >{{ $compensationlist-> HR_PERSON_TYPE_NAME }}</td>  
                                ...
                                <td align="center">
                                    ...
                                    <div class="dropdown-menu" style="width:10px">
                                        ...
                                        <a class="dropdown-item" href="{{ url('admin_compensation/setupcompensationlistpay/'.$compensationlist-> HR_PERSON_TYPE_ID)}}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;">รายจ่าย</a>
