...
<div class="bg-body-light">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ขอเบิกครุภัณฑ์| หน่วยงาน</B></h3>
            {{-- <a href="{{ url('person_dev/persondevadd/'.$inforpersonuserid -> ID)}}"  class="btn btn-info" ><i class="fas fa-plus"></i> เพิ่มการอบรม</a> --}}
            <a href=""  class="btn btn-info" ><i class="fas fa-plus"></i> เพิ่มการขอเบิกพัสดุ</a>
        </div>
                ...
                <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    <thead style="background-color: #FFEBCD;">
                        <tr height="40">                          
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >ครุภัณฑ์ที่ขอเบิก</th>
