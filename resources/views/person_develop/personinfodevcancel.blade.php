...
?>        
                ...
                <div class="block-header block-header-default ">
                            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ยกเลิกคำร้อง ประชุม/อบรม/ดูงาน</B></h3>
                </div>
                <div class="block-content">    

    
        <form  method="post" action="{{ route('perdev.updatecancel') }}" enctype="multipart/form-data">
        @csrf
      ...
      <textarea   name = "CANCEL_COMMENT"  id="CANCEL_COMMENT" class="form-control input-lg" ></textarea>
        ...
        <a href="{{ url('person_dev/persondevinfo/'.$inforpersonuserid -> ID)}}"  class="btn btn-secondary btn-lg" >ปิดหน้าต่าง</a></div><br> 
