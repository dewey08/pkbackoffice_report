                    ...
                    ?>
                        ...
                        <td class="text-font" align="center" style="vertical-align: top;">{{$number}}</td>
                           ...
                           <?php
                            ...
                            <td class="text-font text-pedding" style="vertical-align: top;">{{ DateThai($inforequest -> DATE_WANT) }}</td>
                            <td class="text-font text-pedding"style="vertical-align: top;">{{ $inforequest -> REQUEST_FOR }}</td>
                            <td class="text-font text-pedding" style="vertical-align: top;">{{ $inforequest -> REQUEST_BUY_COMMENT }}</td> 
                            <td class="text-font text-pedding" style="vertical-align: top;">{{ $inforequest -> REQUEST_VANDOR_NAME }}</td> 
                            <td class="text-font text-pedding" align="right" style="vertical-align: top;">{{ number_format($inforequest -> BUDGET_SUM,2) }}</td>
                            <td class="text-font text-pedding"  style="vertical-align: top;">{{ $inforequest -> SAVE_HR_DEP_SUB_NAME }}</td> 
                            <td class="text-font text-pedding"  style="vertical-align: top;">{{ $inforequest -> SAVE_HR_NAME }}</td> 
                            <td align="center">
                                <div class="dropdown">
                                ...
                                <div class="dropdown-menu" style="width:10px">
                                    ...
                                    <a class="dropdown-item"  href="#detail_repairnomalasset" data-toggle="modal"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;" onclick="detail({{ $inforequest -> ID}});"><i class="fas fa-clipboard-check text-success mr-2"></i>ตรวจสอบ</a>
                                        ...
                                        @if($checkref == 0)
                                        <a class="dropdown-item" href="{{ url('manager_medical/medical_purchase_register/'.$inforequest -> ID)}}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;"><i class="fas fa-clipboard-check text-success mr-2"></i>ลงทะเบียนคุม</a>
                                        @endif
                                  
                             
                                    <a class="dropdown-item"  href="{{ url('manager_medical/medical_requestforbuy_edit/'.$inforequest -> ID)}}"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;"><i class="fas fa-edit text-warning mr-2"></i>รายละเอียด/แก้ไข</a>
                                    <a class="dropdown-item" href="{{ url('manager_medical/medical_requestforbuy_cancel/'.$inforequest -> ID)}}" style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;"><i class="fas fa-window-close text-danger mr-2"></i>ยกเลิก</a>    
                                     
                              
                                    <a class="dropdown-item"  href="{{ url('manager_supplies/pdfwant/export_pdfwant/'.$inforequest -> ID)}}"  style="font-family: 'Kanit', sans-serif; font-size: 15px;font-weight:normal;" target="_blank"><i class="fas fa-print text-info mr-2"></i>พิมพ์ใบแสดงความต้องการ</a>
