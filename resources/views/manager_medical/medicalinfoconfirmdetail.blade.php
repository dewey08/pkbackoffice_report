...
<h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>
                          ...
                          ยืนยันรับเข้ายาและเวชภัณฑ์
                             
            <form  method="post" action="{{ route('mmedical.updatewarehouseinfoconfirmdetail') }}" enctype="multipart/form-data">
@csrf    
</B></h3>
...
<input type="hidden" name="RECEIVE_ID" id="RECEIVE_ID" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infocheckreceive->RECEIVE_ID}}" >
      ...
      @endif
       ...
       <div class="row">
        ...
        <div align="right">
        <button type="submit"  onclick="return confirm('หากทำการยืนยันแล้วจะไม่สามารถแก้ไขข้อมูลได้อีก ?')" class="btn btn-hero-sm btn-hero-info" >ยืนยันรับเข้าคลัง</button>
