...
<h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ยกเลิกการขอซื้อขอจ้างยาและเวชภัณฑ์</B></h3>

</div>                
<div class="block-content block-content-full"  style="text-align: left;">

           <form  method="post" action="{{ route('mmedical.medical_requestforbuy_update_cancel') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="modal-footer">
            <div align="right">
              <button type="submit"  class="btn btn-hero-sm btn-hero-danger" >ยืนยันการยกเลิกคำร้อง</button> 
                    <a href="{{ url('manager_medical/requestforbuy') }}" class="btn btn-hero-sm btn-hero-secondary">ปิดหน้าต่าง</a>
            </div>
        </div>
    </form>
