...
<br>
<form  method="post" action="{{ route('mmedical.detail_update') }}" enctype="multipart/form-data">
    @csrf
       ...
       <div class="row">
                        <div class="col-sm-12 row"  align="right">
                                ...
                                <div class="block-content tab-content">
                                    ...
                                    <table class="table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                                        ...
                                        <td>
                                        <input name="RECEIVE_SUB_LOT[]" id="RECEIVE_SUB_LOT[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value="{{$infocheckreceivesub->RECEIVE_SUB_LOT}}" >
                                        </td>
                                        <td>
        ...
        <div class="modal-footer">
                <div align="right">
                        ...
                        <a href="{{ url('manager_medical/detail')  }}" onclick="return confirm('ต้องการที่จะยกเลิกการแก้ไขข้อมูล ?')" class="btn btn-hero-sm btn-hero-danger"  >ยกเลิกการแก้ไข</a>
                </div>       
        </div>
    </form>  
