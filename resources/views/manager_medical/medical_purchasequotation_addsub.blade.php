...
<form  method="post" action="{{ route('mmedical.savepurchasequotationsub') }}"  enctype="multipart/form-data"  class="needs-validation" novalidate>      
    @csrf
...
<div class="modal-footer">
        ...
        <a href="{{ url('manager_medical/medical_purchasequotation_add/'.$IDCON)  }}" class="btn btn-hero-sm btn-hero-danger" onclick="return confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close mr-2"></i>ยกเลิก</a>
        </div>
