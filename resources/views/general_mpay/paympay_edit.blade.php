...
<div class="bg-body-light">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>แก้ไขจ่ายออก| หน่วยงาน</B></h3>
            <br>
        </div>
        <br>
        <form  method="post" action="{{ route('gen_mpay.paympay_update') }}" enctype="multipart/form-data">
@csrf

<input type="hidden" value="{{$mpaypays->MPAY_PAY_ID}} " name="MPAY_PAY_ID" id="MPAY_PAY_ID" class="form-control input-sm">
        ...
        <div class="col-lg-2">
        <input value="{{$mpaypays->MPAY_PAY_CODE}} " name="MPAY_PAY_CODE" id="MPAY_PAY_CODE" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;">
        </div> 
        <div class="col-lg-1" style="text-align: left">
        <label >                           
                            วันที่ :              
        ...
        <div class="col-lg-4" >
        <input value="{{$mpaypays->MPAY_PAY_COMMENT}} " name="MPAY_PAY_COMMENT" id="MPAY_PAY_COMMENT" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
        </div> 
        </div>
                                    ...
                                    <tr style="text-align: center; font-size: 13px;">
                                        ...
                                        <select name="MPAY_PAY_SUB_TYPEID[]" id="MPAY_PAY_SUB_TYPEID" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" >
                                            <option value="" >--กรุณาเลือก--</option>
                                                                    ...
                                                                    @if($mpay_setupasset->SETUPASSET_PIECES_ID == $mpay_sub->MPAY_PAY_SUB_TYPEID)
                                       ...
                                       <td >
                                       <input style="text-align: center; " value="{{ $mpay_sub ->MPAY_PAY_SUB_AMOUNT  }}" name="MPAY_PAY_SUB_AMOUNT[]" id="MPAY_PAY_SUB_AMOUNT" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  >
                                       </td>
