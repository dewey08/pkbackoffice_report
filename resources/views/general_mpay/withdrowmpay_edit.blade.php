...
<div class="bg-body-light">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>แก้ไขขอเบิกอุปกรณ์ | หน่วยงาน</B></h3>
            <br>
        </div>
        <br>
<form  method="post" action="{{ route('gen_mpay.withdrowmpay_update') }}" enctype="multipart/form-data">
@csrf

<input type="hidden" value="{{$mpaywithdrows->MPAY_WITHDROW_ID}} " name="MPAY_WITHDROW_ID" id="MPAY_WITHDROW_ID" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  >
...
<div class="col-sm-12" style="text-align: left">
        ...
        <div class="col-lg-2">
        <input value="{{$mpaywithdrows->MPAY_WITHDROW_CODE}} " name="MPAY_WITHDROW_CODE" id="MPAY_WITHDROW_CODE" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  >
        </div> 
        <div class="col-lg-1" style="text-align: left">
        <label >                           
                            ปีงบประมาณ          
        ...
        <div class="col-lg-4" >
        <input value="{{$mpaywithdrows->MPAY_WITHDROW_COMMENT}} " name="MPAY_WITHDROW_COMMENT" id="MPAY_WITHDROW_COMMENT" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" >
        </div> 
        </div>
      ...
      <input type="hidden" name="MPAY_WITHDROW_HR_ID" id="MPAY_WITHDROW_HR_ID" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;" value=" {{$inforpersonuserid->ID}}">
       ...
       <table class="gwt-table table-striped table-vcenter " style="width: 100%;">
                    <thead style="background-color: #FFEBCD;">
                                        ...
                                        <tbody class="tbody1"> 
                                            <?php $number = 0; ?>
                                            @foreach ($mpaywithdrow_subs as $mpaywithdrow_sub)
                                            <?php $number++; ?>
                                                ...
                                                <tr style="text-align: center; font-size: 13px;">
                                                    ...
                                                    <select name="MPAY_WITHDROW_SUB_TYPE[]" id="MPAY_WITHDROW_SUB_TYPE[]" class="form-control input-sm " style=" font-family: 'Kanit', sans-serif;" >
                                                                    ...
                                                                    @if($mpay_setupasset->SETUPASSET_PIECES_ID == $mpaywithdrow_sub->MPAY_WITHDROW_SUB_TYPE)
                                                                            <option value="{{ $mpay_setupasset ->SETUPASSET_PIECES_ID  }}" selected>{{ $mpay_setupasset ->SETUPASSET_PIECES_NAME  }}</option>                                                                                                                        
                                                                    @else
                                                    ...
                                                    <td style="text-align: left;" class="text-pedding">
                                                    <input style="text-align: center; " value="{{$mpaywithdrow_sub->MPAY_WITHDROW_SUB_AMOUNT }}" name="MPAY_WITHDROW_SUB_AMOUNT[]" id="MPAY_WITHDROW_SUB_AMOUNT[]" class="form-control input-sm" style=" font-family: 'Kanit', sans-serif;"  >
                                                </td>
