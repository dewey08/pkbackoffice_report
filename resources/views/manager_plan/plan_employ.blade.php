    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ข้อมูลแผนงานจัดจ้าง จ้างเหมา ค่าเช่า ปรับปรุง</B></h3>
                <a href="{{ url('manager_plan/employ_add') }}"    class="btn btn-hero-sm btn-hero-info" ><i class="fas fa-plus"></i> เพิ่มข้อมูล</a>
            </div>
                ...
                <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    <thead style="background-color: #FFEBCD;">
                        <tr height="40">
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >ทีมประสาน</th>
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >	แบบแปลนเลขที่(ถ้ามี)	</th>
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >	จำนวนหน่วย	</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" >	จำนวนเงิน(บาท)	</th>
