                ...
                <table class="table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    <thead style="background-color: #FFEBCD;">
                        <tr height="40">
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center; border: 1px solid black;" width="5%">ประเภท</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center; border: 1px solid black;" width="5%">รหัส</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center; border: 1px solid black;" width="5%">ทีม/หน่วยงาน</th>
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center; border: 1px solid black;" width="9%">	ผู้รับผิดชอบ	</th>
                    ...
                    <?php $number++; ?>
                        ...
                        <tr height="20">
                                ...
                                <td class="text-font text-pedding" width="7%">{{DateThai($infohumandev->HUM_BEGIN_DATE)}}</td>
                                <td class="text-font text-pedding" width="7%">{{DateThai($infohumandev->HUM_END_DATE)}}</td>
                                <td class="text-font text-pedding" width="7%">{{$infohumandev->BUDGET_NAME}}</td>
                                <td class="text-font text-pedding" align="right" width="7%">{{number_format($infohumandev->BUDGET_PICE,2)}}</td>
                                <td class="text-font text-pedding" align="right" width="7%">{{number_format($infohumandev->BUDGET_PICE_REAL,2)}}</td>
