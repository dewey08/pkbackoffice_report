    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>รายการรับคืน</B></h3>
                <div align="right">
                ...
                <table class="gwt-table table-striped table-vcenter js-dataTable-simple" style="width: 100%;">
                    <thead style="background-color: #FFEBCD;">
                        ...
                        <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="5%">ลำดับ</th>
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="10%" >เจ้าหน้าที่ส่งคืน</th>  
                    ...
                    <tbody>
                        ...
                        <tr height="20">
                            ...
                            <td class="text-font text-pedding" >R63-0001</td>
                            <td class="text-font text-pedding" >12 มิ.ย. 63</td>
                            <td class="text-font text-pedding" >01</td>
                            <td class="text-font text-pedding" >25</td>
                            <td class="text-font text-pedding" >จิระ ขันทอง</td>
                            <td class="text-font text-pedding" >จิตสง่า </td>                      
                            <td align="center">
                                <div class="dropdown">
