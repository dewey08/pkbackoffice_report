    ...
    <div class="block" style="width: 95%;">
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>รายการจ่ายของ</B></h3>
                <div align="right">
             ...
             <div class="table-responsive"> 
                    ...
                    <thead style="background-color: #FFEBCD;">
                        ...
                        <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="5%">ลำดับ</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="10%">เลขที่จ่าย</th>
                            ...
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="10%" >หน่วยงานรับ</th>
                            <th  class="text-font" style="border-color:#F0FFFF;text-align: center;" width="10%" >เจ้าหน้าที่จ่าย</th>  
                    ...
                    <tbody>
                        ...
                        <tr height="20">
                            ...
                            <td class="text-font text-pedding" >P63-0001</td>
                            <td class="text-font text-pedding" >10 มิ.ย. 63</td>
                            <td class="text-font text-pedding" >01</td>
                            <td class="text-font text-pedding" >50</td>
                            <td class="text-font text-pedding" >ผู้ป่วยใน 1</td> 
                            <td class="text-font text-pedding" >จิตสง่า เพชรสุวรรณ</td>
                            <td class="text-font text-pedding" >จิระ ขันทอง</td>                      
                            <td align="center">
                                <div class="dropdown">
