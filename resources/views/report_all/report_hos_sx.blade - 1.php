                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($datashow as $item3) 
                                                            <tr>                                                  
                                                                ...
                                                                <td class="text-center" width="3%">{{ $item3->hn }}</td> 
                                                                <td class="text-center" width="3%">{{ $item3->an }}</td> 
                                                                <td class="text-start"  width="3%">{{ $item3->ptname }}</td>  
                                                                <td class="text-center" width="3%">{{ $item3->sexname }}</td>
                                                                <td class="text-center" width="3%">{{ $item3->age_y }}</td> 
                                                                <td class="text-center" width="3%">{{ $item3->pdx }}</td> 
                                                                <td class="text-start"  width="3%">{{ $item3->dx0 }}</td>  
                                                                <td class="text-center" width="3%">{{ $item3->dx1 }}</td>
                                                                <td class="text-center" width="3%">{{ $item3->dx2 }}</td>
                                                                <td class="text-center" width="3%">{{ $item3->dx3 }}</td> 
                                                                <td class="text-center" width="3%">{{ $item3->dx4 }}</td> 
                                                                <td class="text-start"  width="3%">{{ $item3->dx5 }}</td>  
                                                                <td class="text-center" width="3%">{{ $item3->dctype }}</td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
